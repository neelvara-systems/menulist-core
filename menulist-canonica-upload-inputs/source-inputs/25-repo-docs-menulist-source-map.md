# MenuList Repo Documentation Source Map For Canonica

## Purpose

This source maps the MenuList repo documentation families that should back Canonica knowledge. It prevents Canonica from relying only on public website copy when live SMB owners ask operational questions.
...
Canonica must not claim universal POS, Google, delivery app, or external-platform sync unless the specific account/integration is enabled and verified.
...
## Canonica Upload Rule

Canonica should ingest summarized source files first, then attach individual repo docs as source evidence only where needed. If a Canonica answer conflicts with the live public website or current runtime behavior, do not publish it as canonical until reviewed.
