...
## What Canonica Can Safely Explain
...
For those topics, Canonica should give the safe next step: check Billing, open a support ticket, or contact MenuList support.

## Privacy Boundary

Do not expose card numbers, UPI IDs, transaction IDs, invoices, Razorpay IDs, or private billing metadata in Canonica answers or screenshots.
