# Production Data Safety For MenuList Canonica Assets

## Rule

Production MenuList data can support Canonica screenshots only after approval, minimization, and scrub. The fact that MenuList and Canonica are related products does not make private MenuList data public marketing material.
...
- Canonica dashboard screenshots that show MenuList knowledge state after private values are scrubbed.
...
Before any screenshot becomes a Canonica website or marketing asset:
...
- Confirm Canonica dashboard counts do not reveal private user/customer details.
- Confirm all generated Canonica answers shown are reviewed or clearly draft-only.
- Confirm the screenshot does not imply Canonica is a restaurant menu product.
- Confirm the screenshot does not imply Canonica replaces a helpdesk, CMS, or support team.
...
Real proof starts only after MenuList is onboarded as a Canonica production client and the approved routed captures are saved under:
