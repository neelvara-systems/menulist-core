...
| FAQs | 20 to 30 reviewed FAQ entries, seeded from the 50-question FAQ CSV | Shows buyer/support coverage without overwhelming the dashboard. |
...
| Product Surfaces | 8 to 12 MenuList surfaces mapped with route patterns and linked knowledge | Shows page-aware support. |
...
- widget test questions and feedback signals from MenuList owner routes.
