...
The website frames the customer problem as public menu drift:

- old Google listing prices or hours;
- wrong QR menu;
- old PDFs circulating on WhatsApp;
- inconsistent pricing across public places.
...
- customer actions such as call, WhatsApp, directions, photos, and menu access;
- saved menu shortcut;
- digital screens;
- print/PDF;
- Menu Kit/launch materials;
...
- optional language choice when the business publishes more than one language;
- business identity;
- open status;
- recent update/freshness indicators;
- prices and item details;
- customer actions.

## Website Claim Boundaries

Answerlattice must preserve these limits:

- MenuList does not guarantee Google ranking, Google Maps placement, ChatGPT citation, or external platform refresh.
...
This source should help Answerlattice answer:
...
- "What is included in the public customer-facing system?"
