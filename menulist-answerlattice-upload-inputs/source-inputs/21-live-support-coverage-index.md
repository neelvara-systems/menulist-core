...
This index defines the minimum MenuList support coverage required before live SMB owners use Answerlattice for help.
...
| Screenshot and asset boundaries | `07`, `09`, `10` | Required for Answerlattice website/demo assets. |
| Live website public truth | `22`, `23`, `24` | Required so Answerlattice matches current public claims. |
| Repo docs source map and operational gaps | `25`, `26` | Required so Answerlattice knows where deeper source evidence lives. |

## Must-Be-Reviewed Before Production Use

Before enabling Answerlattice for live MenuList owners, review and approve:
...
- all screenshots used for Answerlattice website/demo assets.
...
Answerlattice should retrieve account-specific state only through approved authenticated Answerlattice/MenuList runtime paths after production onboarding.

## Launch Rule

If a live owner asks a question and the answer is not covered by an approved source or canonical answer, Answerlattice should not guess. It should route to support and record the missing answer as an Answerlattice knowledge gap.
