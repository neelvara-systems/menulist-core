...
export async function sendMenuListEmailOs(envelopeInput: EmailOsEnvelope): Promise<EmailOsProviderResult> {
    ...
    if (envelope.productCode !== 'ML') return configurationRejected('EMAIL_OS_PRODUCT_RUNTIME_MISMATCH');
