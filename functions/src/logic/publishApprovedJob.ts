...
export const publishApprovedJobLogic = async (jobId: string, finalCategories: IngestionJobCategoriesMap) => {
    ...
    // CORRECTED: Reference to your existing categories document.
    const categoriesDocRef = firestoreAdmin.collection(KB_CATEGORIES_COLLECTION).doc('categories');
    ...
    try {
        await firestoreAdmin.runTransaction(async (transaction) => {
            ...
            logger.info(`[publishApprovedJobLogic] Merged navigation blueprint into kb_categories/categories.`);
