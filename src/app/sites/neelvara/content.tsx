...
type PageData = {
  slug:
    "products" | "about" | "contact" | "trust" | "legal" | "privacy" | "terms";
  title: string;
  description: string;
  headline?: string;
  eyebrow: string;
...
export const OPERATING_ROWS: InfoCard[] = [
  {
    ...
    description:
      "Business, legal, and privacy questions route to direct Neelvara email addresses.",
    icon: LuBuilding2,
    meta: "Direct inboxes",
    variant: "blue",
  },
  ...
  },
  {
    ...
    description:
      "Company questions use direct email routing; product support remains on product sites.",
    icon: LuShieldCheck,
    meta: "Company email",
    variant: "violet",
  },
...
const PRODUCT_ICON_BY_NAME: Record<
  (typeof NEELVARA_PRODUCT_LINEUP)[number]["name"],
  IconType
> = {
...
export const PAGE_DATA: Record<PageData["slug"], PageData> = {
  products: {
    ...
    description:
      "Products currently operated by Neelvara Systems and links to their official websites.",
  ...
  about: {
    ...
    cards: [
      {
        ...
        description:
          "The work is centered on public facts, support knowledge, and approved answers.",
        icon: LuFileText,
      ...
      },
      {
        ...
        description:
          "The company favors maintained information sources over noisy dashboards or broad public promises.",
        icon: LuShieldCheck,
        meta: "Low noise",
        variant: "indigo",
      },
      {
        ...
        description:
          "The operating lens is maintenance reduction: fewer repeated updates, clearer public facts, and less support drift.",
        icon: LuBuilding2,
    ...
    closing: {
      ...
      title:
        "Products keep their own websites. Neelvara provides the company reference behind them.",
  ...
  contact: {
    ...
    title: "Contact",
    description:
      "Contact Neelvara Systems for company, legal, privacy, partnership, or business inquiries.",
    ...
    sections: [
      ...
      },
      {
        ...
        items: NEELVARA_PRODUCT_LINEUP.map(
  ...
  trust: {
    ...
    description:
      "A factual reference for verifying Neelvara Systems, its operated products, official contact routes, and the boundary of this company website.",
      ...
      rows: [
        {
          ...
          status: "Published",
          detail:
            "Neelvara Systems is the operating trade name used for this company reference.",
          href: "/legal",
        },
        {
        ...
        },
        {
          ...
          status: "Published",
          detail:
            "A static security contact file is available for responsible disclosure routing.",
        ...
        },
        {
          ...
          detail:
            "Verify controls, policies, and any certifications on the relevant product website.",
          href: "/products",
        },
        {
          ...
          detail:
            "Not asserted on this page; use the legal inbox for reviewed vendor or entity verification.",
          href: `mailto:${NEELVARA_LEGAL_EMAIL}`,
          external: true,
        },
      ],
  ...
  legal: {
    ...
    title: "Legal",
    description:
      "Public entity and product relationship information for Neelvara Systems.",
  ...
  privacy: {
    ...
    description:
      "This Privacy Policy explains how Neelvara Systems handles information related to this company website.",
    ...
    cards: [
      {
        title: "Summary",
        description:
          "This website is an informational company website with no account system or contact form.",
        icon: LuFileText,
  ...
  terms: {
    ...
    title: "Terms of Use",
    description:
      "These Terms govern use of the Neelvara Systems company website.",
    ...
    cards: [
      {
        ...
        description:
          "This website provides company, product relationship, legal, privacy, and contact information.",
        icon: LuFileText,
        meta: "Website use",
        variant: "blue",
      },
      {
        ...
        description:
          "Product usage, billing, refunds, support, and availability are governed by the relevant product terms.",
        icon: LuLayers,
    ...
    <header className="nv-header">
      <div className="nv-header-inner glass">
        <NeelvaraLink
          href="/"
          className="nv-brand"
          aria-label="Neelvara Systems home"
        >
          <NeelvaraLogoMark />
        ...
        <div className="nv-header-actions">
          <a
            className="nv-button nv-button-glass"
            href={`mailto:${NEELVARA_CONTACT_EMAIL}`}
          >
            Email us
  ...
  return (
    <footer className="nv-footer">
      <div className="nv-wrap nv-footer-inner">
        <NeelvaraLink
          className="nv-footer-brandline"
          href="/"
          aria-label="Neelvara Systems home"
        >
          <NeelvaraLogoMark />
          <p>
            © 2026 <span className="nv-wordmark">Neelvara Systems</span>
          </p>
        </NeelvaraLink>
      ...
      {rows.map((row) => {
        const rowContent = (
          <>
            ...
            <span
              className={`nv-trust-status-badge nv-trust-status-${row.status.toLowerCase().replace(/\s+/g, "-")}`}
            >
              {row.status}
            </span>
            <p>{row.detail}</p>
        ...
        if (!row.href) {
          return (
            <div className="nv-trust-status-row" key={row.label}>
              {rowContent}
            </div>
          );
        }
...
export function PageShell({
  ...
  footerArtwork?: React.ReactNode;
}) {
  return (
    <div className="neelvara-site">
      <a className="nv-skip-link" href="#main-content">
    ...
    <PageShell>
      ...
      {page.statusRows ? (
        <section className="nv-section nv-section-tight nv-reveal nv-trust-section">
          <div className="nv-wrap nv-trust-overview nv-section-frame">
      ...
      <div className="nv-wrap nv-document-flow">
        {page.sections.map((section, index) => (
          <section
            className="nv-document-section nv-reveal nv-secondary-section"
            key={section.title}
          >
            <div
              className="nv-text-panel nv-policy-row"
