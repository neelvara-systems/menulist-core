...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Company, legal, privacy, partnership, and business inquiry routes for Neelvara Systems.",
...
export default function NeelvaraContactPage() {
  return (
    <PageShell>
      ...
      <section className="nv-page-hero">
        <div className="nv-wrap nv-page-hero-inner">
          <div className="nv-page-hero-copy nv-reveal">
            ...
            <p>
              Choose a Neelvara inbox for company, legal, privacy, partnership,
        ...
        <div className="nv-wrap nv-section-frame nv-directory-frame">
          <div className="nv-section-head">
            <div>
              ...
              <h2 className="serif">
                Use the email that best matches the inquiry.
              </h2>
            </div>
            <p>
              A short, high-level first message is enough. The right inbox can
              ask for supporting details if needed.
            </p>
          </div>
          <DirectoryCards />
        </div>
      ...
      <div className="nv-wrap nv-document-flow nv-contact-guidance">
        <section className="nv-document-section nv-reveal">
          <div className="nv-text-panel nv-contact-note">
            <div>
              <h2 className="serif">Looking for product support?</h2>
              <p>
                MenuList and Answerlattice keep product-specific support,
                documentation, onboarding, billing, and account questions on
                their own websites.
              </p>
            </div>
            <div className="nv-support-product-grid">
              {NEELVARA_PRODUCT_LINEUP.map((product) => (
                <a
                  className="nv-support-product-link"
                  href={product.url}
                  key={product.name}
                >
          ...
          <div className="nv-text-panel nv-contact-note">
            <div>
              ...
              <p>
                ...
                sensitive documents unless the legal or privacy inbox asks for
                them.
              </p>
            </div>
            <ul className="nv-check-list">
              <li>
                Use the business email for general company, partnership, or
                product relationship questions.
              </li>
              <li>
                Use the legal email for vendor, entity, or contract
                verification.
              </li>
              <li>
                Use the privacy email for company website privacy questions.
              </li>
