...
import NeelvaraAuraOrb from "./NeelvaraAuraOrb";
import NeelvaraHeroField from "./NeelvaraHeroField";
...
export default function NeelvaraHomePage() {
  return (
    <PageShell footerArtwork={<NeelvaraAuraOrb />}>
      <StructuredData />

      <section className="nv-hero nv-hero-centered">
        <NeelvaraHeroField />
        <div className="nv-wrap nv-hero-layout">
          <div className="nv-hero-copy nv-reveal">
            <span className="nv-eyebrow mono">
              Operating company for MenuList and Answerlattice
            </span>
      ...
      <div className="nv-page-flow nv-home-flow">
        <section className="nv-section nv-operating-section nv-reveal">
          <div className="nv-wrap nv-operating-layout nv-section-frame">
            <div className="nv-section-intro">
              <span className="nv-eyebrow mono">Operating approach</span>
              <h2 className="serif">
                A focused company with clear product boundaries.
              </h2>
              <p>
                Neelvara identifies the company behind each product and routes
        ...
        <section
          className="nv-section nv-product-lineup nv-reveal"
          id="products-lineup"
        >
          <div className="nv-wrap nv-product-section nv-section-frame">
            <div className="nv-product-summary">
              ...
              <p>
                MenuList keeps public business information official.
                Answerlattice keeps customer answers grounded in approved
                knowledge. Each product has its own website, policies, and
                support route.
              </p>
            </div>
              ...
              {NEELVARA_PRODUCT_LINEUP.map((product) => (
                ...
                >
                  ...
                  <span className="nv-product-card-link">
                    ...
                    <LuExternalLink
                      className="nv-product-link-icon"
                      aria-hidden="true"
                    />
                  </span>
                </a>
        ...
        <section className="nv-section nv-contact-directory nv-reveal">
          <div className="nv-wrap nv-section-frame nv-directory-frame">
            <div className="nv-section-head">
              ...
              <p>
                Business, legal, and privacy inquiries use direct Neelvara
                inboxes. Product support starts on product websites.
              </p>
            </div>
            <DirectoryCards />
          </div>
