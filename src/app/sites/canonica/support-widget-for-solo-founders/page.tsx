    ...
    return (
        <>
            ...
            <SeoLandingPage
                ...
                description="Launch a support layer from existing docs, FAQs, release notes, and recurring questions before support becomes your full-time job."
                ...
                ownerReview="Canonica keeps the founder in control of authority: generated drafts, fallback gaps, and mutation proposals stay review work before they become approved answers."
                setupSteps={[
