...
const SECTIONS = [
    ...
    },
    {
        ...
        body: [
            ...
            'Canonica may restrict access if an account is inactive, abusive, unsafe, or violates these terms.',
        ],
    },
    {
    ...
    },
    {
        title: 'Contact',
        body: [
            'For terms or account questions, contact hello@canonica.app.',
        ],
    },
];

export default function CanonicaTermsOfServicePage() {
    const basePath = getBasePath();

    return (
        <>
            <CanonicaPageStructuredData path="/terms-of-service" />
