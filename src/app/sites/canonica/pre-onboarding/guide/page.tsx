...
export const metadata: Metadata = {
    ...
    description:
        'End-to-end guide for using the Canonica pre-onboarding prompt with a product repo, docs, public website, owner notes, screenshots, and owner review.',
...
export default function CanonicaPreOnboardingGuidePage() {
    const basePath = getBasePath();

    return (
        <>
            <CanonicaPageStructuredData path="/pre-onboarding/guide" />
                ...
                <section className="border-b border-white/[0.06] bg-white/[0.01] px-4 py-20 sm:px-6">
                    <div className="mx-auto max-w-7xl">
                        <SectionHeader
                            ...
                            description="Some teams expect the agent to turn product sources into support docs, FAQs, walkthroughs, or website asset briefs. Canonica keeps those outputs source-backed and review-gated."
                        />
                ...
                <section className="border-b border-white/[0.06] bg-white/[0.01] px-4 py-20 sm:px-6">
                    <div className="mx-auto max-w-7xl">
                        <SectionHeader
                            ...
                            description="When the owner gives the AI IDE the Canonica link, the agent should follow the source-first operating contract and avoid unsupported certainty."
                        />
                        <div className="grid gap-4 md:grid-cols-2">
                            {[
