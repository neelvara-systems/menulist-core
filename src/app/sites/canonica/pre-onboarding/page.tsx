...
export const metadata: Metadata = {
    ...
    description:
        'Use an AI coding agent to prepare product website links, docs, owner notes, policies, support questions, and screenshot rules before Canonica onboarding.',
...
const OUTPUTS = [
    ...
    },
    {
        ...
        description: 'Manifest and Canonica add-source payloads that match the generated source files.',
        icon: LuDatabase,
    },
    {
        title: 'Support tests',
        description: 'Owner-style questions that prove Canonica can answer routine support and escalate risky topics.',
        icon: LuBookOpen,
    },
    {
...
export default function CanonicaPreOnboardingPage() {
    const basePath = getBasePath();

    return (
        <>
            <CanonicaPageStructuredData path="/pre-onboarding" />
            ...
            <main className="cn-page-flow">
                    ...
                    <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
                        <div>
                            ...
                            <h1 className="max-w-3xl text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
                                Prepare Canonica before setup starts.
                            </h1>
                ...
                <section className="border-b border-white/[0.06] px-4 py-20 sm:px-6">
                    <div className="mx-auto max-w-7xl">
                        <SectionHeader
                            ...
                            title="Structured source truth before Canonica intake."
                            description="The prompt does the preparation work outside Canonica, then leaves the owner with a reviewed package to upload."
                        />
                ...
                <section className="border-b border-white/[0.06] bg-white/[0.01] px-4 py-20 sm:px-6">
                    <div className="mx-auto max-w-7xl">
                        <SectionHeader
                            ...
                            description="The agent prepares the package. Canonica still reviews drafts before anything becomes live support."
                        />
                        <CanonicaSequenceDiagram
                            idPrefix="cn-pre-onboarding-flow"
                            splitAfter={3}
                            items={[
                                ...
                                { title: 'Owner review', detail: 'Remove private data, fix inaccuracies, and approve what can enter Canonica.' },
                                { title: 'Upload to Canonica', detail: 'Use Knowledge Intake to create review drafts from the prepared source set.' },
                ...
                <section className="border-b border-white/[0.06] px-4 py-20 sm:px-6">
                    <div className="mx-auto max-w-7xl">
                        <SectionHeader
                            ...
                            description="A full repo is useful, but not mandatory. The prompt keeps Canonica inputs structured while marking unavailable sources instead of guessing."
                        />
                ...
                <section className="px-4 py-20 sm:px-6">
                    <div className="mx-auto max-w-5xl rounded-[2rem] border border-teal-500/20 bg-teal-500/[0.055] p-6 text-center sm:p-10">
                        ...
                        <h2 className="text-3xl font-bold text-white sm:text-4xl">Give Canonica better source truth on day one.</h2>
