...
export const metadata: Metadata = {
    ...
    description: 'A page-aware support widget for AI-built SaaS that uses safe context, approved answers, FAQs, changelog entries, and fallback signals.',
    ...
    return (
        <>
            ...
            <SeoLandingPage
                ...
                description="Install one widget that uses safe page context, approved answers, FAQs, changelog entries, and fallback signals so users get help related to the screen they are on."
                ...
                ownerReview="The widget serves approved answers first. If coverage is missing, fallback is marked and the repeated gap becomes review work instead of hidden chat history."
                setupSteps={[
