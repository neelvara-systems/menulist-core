...
> Canonica is the support layer for AI-built SaaS apps. It helps founders launch with team access, starter surfaces, import packs, page-aware answers, owner FAQ/custom Q&A, help content, release context, a private Support Board, compiled runtime context, and support gaps connected to approved product knowledge.
...
- [Product](${CANONICA_SITE_URL}/product): Product areas for setup, team access, in-app widget, hosted help with tickets, and answer review.
- [Demo](${CANONICA_SITE_URL}/demo): Static account-free demo with approved answer, fallback, and support-gap states.
- [Install](${CANONICA_SITE_URL}/install): Widget script, allowed origins, blocked routes, safe page context, manual screenshot attachments, and hosted help-domain setup.
...
- [Security](${CANONICA_SITE_URL}/security): Widget context, manual screenshot boundaries, tenant boundary, compiled context boundaries, owner-approved answers, rate limits, and responsible disclosure.
- [Security One-Pager](${CANONICA_SITE_URL}/security-one-pager): Shareable allowed-origin, blocked-route, safe-context, team-role, manual-screenshot, hashed-key, approval, and rate-limit summary.
- [Resources](${CANONICA_SITE_URL}/resources): Launch, team access, widget, Support Board, support-control, and governance resources.
...
- [Help center + tickets](${CANONICA_SITE_URL}/product/support-control): Hosted help, docs, FAQ, custom owner Q&A, changelog, ticket fallback, conversations, Support Board, and weekly review.
...
- [Support Board](${CANONICA_SITE_URL}/product/support-board): Private owner/staff support cards, internal notes, status history, selected follow-up, and answer-proposal handoff.
...
- Treat Support Board as a private owner/staff workboard. Do not say every ticket or signal syncs into it by default; ticket/signal sync and nightly board preparation are controlled rollout paths.
