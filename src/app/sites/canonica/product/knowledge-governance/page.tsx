    ...
    return (
        <>
            ...
            <ProductCapabilityLandingPage
                ...
                description="Canonica keeps approved answers in front, marks fallback clearly, flags stale support, and turns repeated misses into reviewable improvements."
                ...
                workflowSteps={[
                    { title: 'Serve approved answer first', description: 'If approved knowledge matches the page and scope, Canonica uses it before fallback.' },
