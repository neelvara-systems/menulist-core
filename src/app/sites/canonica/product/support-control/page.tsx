...
export const metadata: Metadata = {
    ...
    description: 'Operate Canonica help center, docs, FAQ, custom owner Q&A, changelog, tickets, conversations, Support Board, weekly support review, and workflow notifications from one support control layer.',
    ...
    return (
        <>
            ...
            <ProductCapabilityLandingPage
                ...
                description="Canonica gives you a practical support layer for hosted help, page-aware answers, custom Q&A, ticket fallback, conversations, private Support Board follow-up, weekly review output, and owner notifications."
                activeTab="Help center + tickets"
                tabs={CANONICA_PRODUCT_AREAS}
                canvasTitle="Support operations without support chaos"
                canvasSubtitle="Support Control is the layer for hosted help, knowledge base, FAQ, custom owner answers, changelog, tickets as fallback, conversations, Support Board, workflow notifications, and weekly review output."
                ...
                workflowTitle="Publish help, answer users, track follow-up, and turn fallbacks into review work."
                workflowDescription="Support Control is practical: publish help, answer users, accept fallback tickets, track selected follow-up on Support Board, notify owners when attention is needed, and turn unresolved issues into review work."
                workflowSteps={[
