...
export const metadata: Metadata = {
    ...
    description: 'Operate Canonica help center, docs, FAQ, custom owner Q&A, changelog, tickets, feedback, conversations, Support Board, weekly support review, and workflow notifications from one support control layer.',
    ...
    return (
        <>
            ...
            <ProductCapabilityLandingPage
                ...
                description="Canonica gives you a practical support layer for hosted help, page-aware answers, custom Q&A, ticket fallback, feedback review, conversations, private Support Board follow-up, weekly review output, and owner notifications."
