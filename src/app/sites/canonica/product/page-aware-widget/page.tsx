...
export const metadata: Metadata = {
    ...
    description: 'Install Canonica as a page-aware widget with safe context, allowed origins, blocked routes, hosted help, proactive prompts, and approved answers before fallback.',
    ...
    return (
        <>
            ...
            <ProductCapabilityLandingPage
                ...
                description="Install one widget, pass safe page hints, and let Canonica serve approved answers, related docs, configured proactive prompts, or fallback tickets based on where the user is stuck."
                activeTab="In-app help widget"
                tabs={CANONICA_PRODUCT_AREAS}
                canvasTitle="One widget. Different answers by page."
                canvasSubtitle="One script gives the product a support layer that can prefer the current page, related FAQ, release note, approved answer, and configured proactive trigger before fallback."
                ...
                workflowDescription="Canonica separates the runtime key, allowed origins, blocked routes, page context, and proactive capability checks so widget behavior stays maintainable."
                workflowSteps={[
