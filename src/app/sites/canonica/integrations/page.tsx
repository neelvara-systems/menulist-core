...
export const metadata: Metadata = {
    title: 'Integrations',
    description:
        'Slack and email workflow notifications for Canonica support governance: digest-first alerts, test delivery, compact health, and bounded delivery.',
    ...
    openGraph: {
        ...
        url: `${CANONICA_SITE_URL}/integrations`,
    },
};
...
export default function CanonicaIntegrationsPage() {
            ...
            <main className="cn-page-flow">
                    ...
                    <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
                        <div>
                            ...
                            <p className="mt-6 max-w-2xl text-base leading-relaxed text-[#a0a0c0] sm:text-lg">
                                Canonica connects support governance to Slack and email with digest-first notifications, critical alerts, test delivery, and compact delivery health.
                            </p>
                ...
                <section className="border-b border-white/[0.06] bg-[radial-gradient(circle_at_50%_0%,rgba(20,184,166,0.10),transparent_36%),rgba(255,255,255,0.01)] px-4 py-20 sm:px-6">
                    <div className="mx-auto max-w-7xl">
                        ...
                        <CanonicaSequenceDiagram
                            ...
                            splitAfter={3}
                            items={[
                                { title: 'Connect Slack or email', detail: 'Add the destination in Canonica settings.' },
                ...
                <section className="px-4 py-20 text-center sm:px-6">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-[#a0a0c0]">
                        Start with Slack or email, verify delivery, and keep support review work connected to the Canonica dashboard.
                    </p>
