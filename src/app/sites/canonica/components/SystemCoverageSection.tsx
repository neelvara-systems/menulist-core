        ...
        <section className="border-t border-white/[0.06] px-6 py-24">
            <div className="mx-auto max-w-7xl">
                <SectionHeader
                    ...
                    title="One control plane across setup, support, governance, and runtime."
                    description="Canonica is not only a search box. It connects onboarding, help content, product pages, widget context, tickets, release notes, and review queues so support can keep up with fast-moving software."
                />
