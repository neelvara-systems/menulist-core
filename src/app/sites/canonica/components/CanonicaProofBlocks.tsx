...
export type CanonicaDecisionItem = {
    title: string;
    detail: string;
    label?: string;
    tone?: Tone;
...
export type CanonicaBeforeAfterItem = {
    title: string;
    context: string;
    question: string;
    before: string;
...
export type CanonicaStatusSnapshot = {
    status: string;
    title: string;
    detail: string;
...
export function CanonicaDecisionGrid({ items }: { items: CanonicaDecisionItem[] }) {
    return (
...
export function CanonicaBeforeAfterStrip({ items }: { items: CanonicaBeforeAfterItem[] }) {
    return (
...
export function CanonicaStatusBoard({ items }: { items: CanonicaStatusSnapshot[] }) {
    return (
