        ...
        <section className="border-y border-white/[0.06] bg-[radial-gradient(circle_at_50%_0%,rgba(37,99,235,0.13),transparent_42%),rgba(255,255,255,0.01)] px-4 py-20 sm:px-6">
            <div className="mx-auto max-w-7xl">
                <SectionHeader
                    ...
                    title="Generic AI guesses. Canonica answers from the page the user is on."
                    description="A billing question from Billing should not get the same answer as a setup question from Onboarding. Canonica uses safe page hints to serve the right approved canonical answer or owner FAQ answer."
                >
                    <CanonicaLink
                        basePath={basePath}
                        href="/demo"
