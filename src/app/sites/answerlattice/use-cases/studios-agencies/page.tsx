...
export default function StudiosAgenciesUseCasePage() {
    return (
        <UseCaseLandingPage
            ...
            description="AnswerLattice helps product studios, agencies, and dev teams hand over SaaS products with in-app help, hosted docs, FAQs, changelog, ticket fallback, feedback review, and approved answers already connected."
