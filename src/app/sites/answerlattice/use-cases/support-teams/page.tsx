...
export default function SupportTeamsUseCasePage() {
    return (
        <UseCaseLandingPage
            ...
            description="AnswerLattice keeps approved answers in front of fallback and gives teams a private Support Board for selected follow-up before ticket patterns become reviewable support-knowledge updates."
            ...
            answerlatticeAnswer="You are on Team Settings. AnswerLattice uses the current role and plan context to serve the approved billing-permission answer, then links the team-role FAQ."
