...
const FAQS = [
    ...
    },
    {
        ...
        answer: 'Users can submit ratings, product-area feedback, feature requests, and suggestions from the Help Center. Owners review those items privately in Answerlattice and can move useful feedback into Support Board or answer-proposal review. It is not a public voting board and does not publish answers automatically.',
    },
    {
    ...
    },
    {
        ...
        answer: 'No. Answerlattice is designed around compact summaries, cache freshness checks, and compiled approved context so runtime paths can stay fast and cost-aware. Source data remains governed in Answerlattice, and public bundles do not include drafts, tickets, audit logs, API keys, or private workspace internals.',
    },
    {
