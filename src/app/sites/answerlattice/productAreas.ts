export const ANSWERLATTICE_PRODUCT_AREAS = [
    ...
    },
    {
        ...
        description: 'Turn scattered product knowledge into docs, FAQs, owner answers, release notes, fallback tickets, feedback, ratings, and feature-request follow-up.',
    },
    {
