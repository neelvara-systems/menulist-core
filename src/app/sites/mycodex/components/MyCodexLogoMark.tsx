...
interface MyCodexLogoMarkProps {
    className?: string;
}

export default function MyCodexLogoMark({ className }: MyCodexLogoMarkProps) {
    const gradientPrefix = useId().replace(/:/g, '');
    const leftGradientId = `mycodex-logo-left-${gradientPrefix}`;
    const rightGradientId = `mycodex-logo-right-${gradientPrefix}`;

    return (
        <svg
            viewBox="1528 580 320 533.333333"
        ...
        >
            <defs>
                <linearGradient id={leftGradientId} x1="1335.95" y1="845.436" x2="1784.85" y2="845.436" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#29AAE3" />
                    <stop offset="0.498958" stopColor="#0071BD" />
                    <stop offset="1" stopColor="#0051D2" />
                </linearGradient>
                <linearGradient id={rightGradientId} x1="1595.11" y1="848.904" x2="2048.63" y2="848.904" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#29AAE3" />
