...
export function generateImageEditingPrompt(
    ...
    const userPrompt = sanitizeImageEditingPromptText(generationConfig.prompt, IMAGE_EDITING_PROMPT_TEXT_MAX_LENGTH);
...
5.  **Output as PNG:** Deliver the final image as a PNG with a fully transparent alpha channel.
    ...
    const coreTaskDescription = replacePlaceholders(feature.prompt, safeItemDetails);
