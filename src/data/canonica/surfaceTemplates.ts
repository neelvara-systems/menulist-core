import type { CanonicaProductSurfaceVisibility } from '@type/canonica';

export type CanonicaSurfaceTemplate = {
    key: string;
    label: string;
    description: string;
...
const defaultVisibility: CanonicaProductSurfaceVisibility = {
    helpWidget: true,
    helpCenter: true,
    changelog: true,
};

export const CANONICA_SURFACE_TEMPLATES: CanonicaSurfaceTemplate[] = [
    {
