...
export const OWNER_NOTIFICATION_REGISTRY: OwnerNotificationRegistryEntry[] = [
  ...
  },
  {
    ...
    quietHours: 'respect',
    requiresWhatsAppConsent: true,
    templateKey: 'menulist.billing_document_issued',
    requiredMetadata: ['documentNumber', 'documentTypeLabel', 'documentUrl'],
  },
  ...
  }),
  {
    ...
    quietHours: 'respect',
    requiresWhatsAppConsent: true,
    templateKey: 'answerlattice.billing_document_issued',
    requiredMetadata: ['documentNumber', 'documentTypeLabel', 'documentUrl'],
  },
  {
    productId: 'AL',
