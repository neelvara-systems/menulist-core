/**
 * Canonica — Procedure Validation (Guided Workflows)
 * 
...
const VALID_ACTIONS = new Set(Object.values(CANONICA_PROCEDURE_ACTIONS));
const VALID_SEVERITIES = new Set(Object.values(CANONICA_WARNING_SEVERITY));
const VALID_PREREQ_TYPES = new Set(Object.values(CANONICA_PREREQUISITE_TYPE));
const C = CANONICA_PROCEDURE_CONSTRAINTS;
...
export function validateProcedure(
    ...
    if (!answerType || answerType !== CANONICA_ANSWER_TYPES.PROCEDURE) {
 ...
 */
export function normalizeStepOrder(procedure: CanonicaProcedure): void {
