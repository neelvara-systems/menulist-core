/**
 * Canonica — Knowledge Graph Exploitation (Expansion Item #11)
 * 
...
import type {
    ...
    CanonicaEntityGraphNode,
    CanonicaGraphExpansionResult,
    CanonicaInteractionRule,
} from '@type/canonica';
...
export async function loadGraphIndex(
    tId: number,
    sId: number
): Promise<CanonicaEntityGraphIndex | null> {
...
export function expandViaGraph(
    ...
    graphIndex: CanonicaEntityGraphIndex
): string[] {
...
export function findMatchingInteraction(
    ...
    rules: CanonicaInteractionRule[] | undefined
): CanonicaInteractionRule | null {
...
export function buildRelatedSuggestions(
    expandedEntities: string[],
    graphIndex: CanonicaEntityGraphIndex,
    bestAnswer: CanonicaCanonicalAnswer | undefined
...
export async function runGraphExploitation(
    ...
    const graphExpansion: CanonicaGraphExpansionResult = {
