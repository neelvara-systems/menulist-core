export const ANSWERLATTICE_PRE_ONBOARDING_PROMPT_TITLE = 'Answerlattice Pre-Onboarding Master Prompt';
export const ANSWERLATTICE_PRE_ONBOARDING_MARKDOWN_RESPONSE_HEADERS = {
    'Content-Type': 'text/markdown; charset=utf-8',
    'Cache-Control': 'public, max-age=3600, s-maxage=86400',
    'X-Content-Type-Options': 'nosniff',
} as const;

export function renderAnswerlatticePreOnboardingOwnerGuide(): string {
    return [
        '# Answerlattice Pre-Onboarding Owner Guide',
        '',
        'Use this guide before you run the Answerlattice pre-onboarding prompt in your AI coding tool.',
        '',
        '## What You Are Preparing',
        '',
        'You are preparing source truth for Answerlattice Knowledge Intake. The goal is not to make a polished marketing document. The goal is to give Answerlattice enough reviewed product context to create support drafts, product surface mappings, FAQ seeds, answer proposals, and live-support readiness checks.',
        '',
        '## Minimum Inputs',
        '',
        ...
        '- `APPROVAL_STATUS`, `SCREENSHOT_MARKETING_PERMISSION`, `ANSWERLATTICE_WORKSPACE_STATUS`: paste the current approval/workspace status.',
        '- `AI_TOOL_PRIVATE_SOURCE_PERMISSION`: choose whether approved private source material may be processed in the selected AI tool.',
        ...
        '6. Ask it to patch gaps inside the generated package before final handoff. Do not let it change product code or source documentation unless you request that separately and review the changes.',
        '7. Review the generated folder before upload.',
        '',
        '## If The Repo Has Multiple Products',
        '',
        'Tell the agent which product Answerlattice is onboarding. Fill `TARGET_PRODUCT_PATHS` when you know them and `EXCLUDED_PRODUCT_NAMES` for sister products that must stay out. The agent should map the codebase first, include shared infrastructure only when it affects the target product, and document exclusions before upload.',
        '',
        ...
        '',
        'No prompt can guarantee perfect output for every product, model, IDE, private app, or source shape. Owner review is mandatory before uploading the package to Answerlattice or using the material for support, website, FAQ, demo, or screenshot assets.',
        '',
        ...
        '- sources you do not own or are not authorized to process in the selected AI tool;',
        '- private source links marked as safe for public citation.',
        '',
        'Remove or correct anything questionable before uploading to Answerlattice.',
        '',
        ...
        '',
        'Do not enable Answerlattice for live users until:',
        '',
...
export function renderAnswerlatticePreOnboardingAgentGuide(): string {
    return [
        '# Answerlattice Pre-Onboarding Agent Guide',
        '',
        'This guide is for the AI coding agent receiving the Answerlattice pre-onboarding prompt.',
        '',
        '## Operating Role',
        '',
        'You are not selling Answerlattice and you are not publishing support answers. You are preparing a source-backed input package that the product owner can review and upload into Answerlattice Knowledge Intake.',
        '',
        '## First Principles',
        '',
        ...
        '9. Patch gaps in the generated package before declaring readiness. Do not modify the client product, source documentation, policies, or production data unless the owner requests that as a separate reviewed task.',
        '10. Record source authority, status, visibility, citation eligibility, applicability, and conflicts. A connected source is evidence, not automatically approved truth.',
        '11. Treat tickets, chats, macros, and repeated replies as support signals unless an authorized owner explicitly approves their facts.',
        '',
        '## Capability Limits',
        '',
        ...
        '- Multiple products in one repo: identify the target product first, include shared code only when it affects the target product support truth, and exclude sister-product docs/routes/features from Answerlattice inputs.',
        ...
        '## Output Quality Bar',
        '',
        'The package should be useful to Answerlattice without another long discovery pass. It should include product truth, support coverage, source maps, risk boundaries, test questions, and upload skeletons.',
        '',
        ...
        '- every source has authority, status, access scope, citation eligibility, applicability, and conflict metadata;',
        '- private sources are authorized for the selected AI tool and are not marked for public citation;',
        '- support exports remain signals rather than approved truth;',
...
export function renderAnswerlatticePreOnboardingPrompt(): string {
    return [
