...
export const PLATFORM_DISCOVERY_PAGES: PlatformDiscoveryPage[] = [
    ...
    },
    {
        ...
        description: 'Browser-local asset maker for a simple QR poster that points customers to one current customer link without storing owner-entered content',
        changeFrequency: 'monthly',
        priority: 0.78,
    },
    {
        ...
        description: 'Browser-local asset maker for a WhatsApp Status or story image that points customers to one current customer link',
        changeFrequency: 'monthly',
        priority: 0.78,
    },
    {
        ...
        description: 'Browser-local asset maker for a regular or special-hours poster that keeps the current customer link visible',
        changeFrequency: 'monthly',
        priority: 0.78,
    },
    {
        ...
        description: 'Browser-local asset maker for a counter card or business-card style QR asset for one current customer link',
        changeFrequency: 'monthly',
        priority: 0.78,
    },
    {
        ...
        description: 'Browser-local asset maker for an ethical feedback QR card using an owner-provided feedback or review link',
        changeFrequency: 'monthly',
        priority: 0.78,
    },
    {
