...
import type { AnswerlatticeBillingDocument } from './answerlatticeBillingDocumentPolicy';
...
const addressLines = (document: AnswerlatticeBillingDocument): string[] => {
...
export const renderAnswerlatticeBillingDocumentPdf = (document: AnswerlatticeBillingDocument): Uint8Array => {
    ...
    pdf.setProperties({
        ...
        subject: 'Answerlattice billing document',
    ...
    pdf.setFontSize(19);
    pdf.text('Answerlattice', margin, 20);
    pdf.setFontSize(15);
