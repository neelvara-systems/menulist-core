...
type DateTimeFormatsEntry = { labelHelper: string; label: string; value: DateTimeFormatOptions }
...
export const DATE_FORMATS: DateTimeFormatsEntry[] = [
    { labelHelper: "short month", label: "numeric|short|numeric", value: { day: 'numeric', month: 'short', year: 'numeric' } },
    { labelHelper: "numeric", label: "numeric|numeric|numeric", value: { day: 'numeric', month: 'numeric', year: 'numeric' } },
    { labelHelper: "numeric, 2-digit year", label: "numeric|numeric|2-digit", value: { day: 'numeric', month: 'numeric', year: '2-digit' } },
    { labelHelper: "numeric, padded day and month", label: "2-digit|2-digit|numeric", value: { day: '2-digit', month: '2-digit', year: 'numeric' } },
    { labelHelper: "short month, padded day", label: "2-digit|short|numeric", value: { day: '2-digit', month: 'short', year: 'numeric' } },
    { labelHelper: "short month, padded day, 2-digit year", label: "2-digit|short|2-digit", value: { day: '2-digit', month: 'short', year: '2-digit' } },
    { labelHelper: "long month, padded day", label: "2-digit|long|numeric", value: { day: '2-digit', month: 'long', year: 'numeric' } },
    { labelHelper: "long month, padded day, 2-digit year", label: "2-digit|long|2-digit", value: { day: '2-digit', month: 'long', year: '2-digit' } },
]

export const TIME_FORMATS: TimeFormatsEntry[] = [
    { labelHelper: "12 Hr format, no leading zero", label: "numeric|numeric|true", value: { hour: 'numeric', minute: 'numeric', hour12: true } },
    { labelHelper: "12 Hr format, leading zero", label: "2-digit|2-digit|true", value: { hour: '2-digit', minute: '2-digit', hour12: true } },
    { labelHelper: "24 Hr format, no leading zero", label: "numeric|numeric|false", value: { hour: 'numeric', minute: 'numeric', hour12: false } },
    { labelHelper: "24 Hr format, leading zero", label: "2-digit|2-digit|false", value: { hour: '2-digit', minute: '2-digit', hour12: false } },
]
