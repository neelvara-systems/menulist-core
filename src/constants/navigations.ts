...
export const NAVIGARIONS_ROUTINGS = {
    ...
    PLATFORM_ANSWERLATTICE_EARLY_ACCESS: `/platform/answerlattice-early-access`,
...
export const SIDEBAR_DASHBOARD_LAYOUT: NavItemType[] = [
    ...
    { label: 'Projects', route: NAVIGARIONS_ROUTINGS.PROJECTS, icon: LuFolderHeart, ownerLabelKey: 'menu', sectionLabel: 'Update what customers see' },
    { label: 'Business Settings', route: NAVIGARIONS_ROUTINGS.BUSINESS_SETTINGS, icon: LuHotel },
    { label: 'Use MenuList', route: NAVIGARIONS_ROUTINGS.USE_MENULIST, icon: LuShare2, ownerLabelKey: 'share', sectionLabel: 'Share and place the link' },
    ...
    {
        label: 'Users List',
        route: NAVIGARIONS_ROUTINGS.USERS_LIST,
