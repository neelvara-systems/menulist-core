...
export const SIGNALDESK_FIREBASE_ENV = {
    API_KEY: "NEXT_PUBLIC_SIGNALDESK_FIREBASE_API_KEY",
    APP_ID: "NEXT_PUBLIC_SIGNALDESK_FIREBASE_APP_ID",
    AUTH_DOMAIN: "NEXT_PUBLIC_SIGNALDESK_FIREBASE_AUTH_DOMAIN",
    CLIENT_EMAIL: "SIGNALDESK_FIREBASE_CLIENT_EMAIL",
    FIREBASE_MODE: "SIGNALDESK_FIREBASE_MODE",
    FIRESTORE_DATABASE_ID: "SIGNALDESK_FIRESTORE_DATABASE_ID",
    GOOGLE_APPLICATION_CREDENTIALS: "SIGNALDESK_GOOGLE_APPLICATION_CREDENTIALS",
    MESSAGING_SENDER_ID: "NEXT_PUBLIC_SIGNALDESK_FIREBASE_MESSAGING_SENDER_ID",
    PRIVATE_KEY: "SIGNALDESK_FIREBASE_PRIVATE_KEY",
    PROJECT_ID: "SIGNALDESK_FIREBASE_PROJECT_ID",
    PUBLIC_FIREBASE_MODE: "NEXT_PUBLIC_SIGNALDESK_FIREBASE_MODE",
    PUBLIC_FIRESTORE_DATABASE_ID: "NEXT_PUBLIC_SIGNALDESK_FIRESTORE_DATABASE_ID",
    PUBLIC_PROJECT_ID: "NEXT_PUBLIC_SIGNALDESK_FIREBASE_PROJECT_ID",
    PUBLIC_STORAGE_BUCKET: "NEXT_PUBLIC_SIGNALDESK_FIREBASE_STORAGE_BUCKET",
    STORAGE_BUCKET: "SIGNALDESK_FIREBASE_STORAGE_BUCKET",
} as const;
