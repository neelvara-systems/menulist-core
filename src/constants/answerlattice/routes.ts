...
export const ANSWERLATTICE_ROUTES = {
    ...
    KNOWN_ISSUES: `${ANSWERLATTICE_BASE_PATH}/known-issues`,
    GOVERNANCE: `${ANSWERLATTICE_BASE_PATH}/governance`,
    LAUNCH_ANSWERS: `${ANSWERLATTICE_BASE_PATH}/launch-answers`,
    ANSWER_TESTS: `${ANSWERLATTICE_BASE_PATH}/answer-tests`,
    ...
    WORKFLOW_NOTIFICATIONS: `${ANSWERLATTICE_BASE_PATH}/workflow-notifications`,
    PUBLIC_API: `${ANSWERLATTICE_BASE_PATH}/public-api`,
