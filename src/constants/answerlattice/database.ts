...
export const ANSWERLATTICE_DB_COLLECTIONS = {
    ...
    ANSWERLATTICE_EMAIL_OS_DELIVERIES: 'answerlattice_emailOsDeliveries',
    ANSWERLATTICE_EMAIL_OS_WEBHOOK_RECEIPTS: 'answerlattice_emailOsWebhookReceipts',
    ANSWERLATTICE_EMAIL_OS_SUPPRESSIONS: 'answerlattice_emailOsSuppressions',
    ANSWERLATTICE_WHATSAPP_OS_MESSAGE_REFS: 'answerlattice_whatsappOsMessageRefs',
    ANSWERLATTICE_WHATSAPP_OS_WEBHOOK_RECEIPTS: 'answerlattice_whatsappOsWebhookReceipts',
    ANSWERLATTICE_WHATSAPP_OS_CONSENT_EVENTS: 'answerlattice_whatsappOsConsentEvents',
