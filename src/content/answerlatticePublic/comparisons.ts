...
export const ANSWERLATTICE_COMPARISONS: AnswerlatticeComparison[] = [
    {
        ...
        metaDescription: 'Compare AnswerLattice with generic chatbots for page-aware support, approved answers, fallback, and human-reviewed support gaps.',
        eyebrow: 'Comparison',
        ...
        tableRows: [
            { label: 'Main job', conventional: 'Respond to user prompts.', answerlattice: 'Serve approved page-aware answers and capture missing coverage.' },
        ...
        faq: [
            {
                ...
                answer: 'No. AnswerLattice can provide a page-aware widget, but its product center is governed support knowledge, not generic conversation.',
            },
            {
    ...
    },
    {
        ...
        metaDescription: 'Compare AnswerLattice with helpdesks for support knowledge governance, tickets as fallback, page-aware answers, and review workflows.',
        eyebrow: 'Comparison',
        ...
        tableRows: [
            ...
            { label: 'Best use', conventional: 'Support team operations.', answerlattice: 'Launch-ready support setup and support knowledge governance.' },
        ],
        faq: [
            {
    ...
    },
    {
        ...
        metaDescription: 'Compare AnswerLattice with knowledge bases for hosted help, page-aware widget answers, approved Q&A, drift review, and support gaps.',
        eyebrow: 'Comparison',
        ...
        tableRows: [
            { label: 'Main job', conventional: 'Publish and organize support articles.', answerlattice: 'Use reviewed sources to serve approved answers, owner Q&A, hosted help, and support-gap review.' },
            { label: 'Answer path', conventional: 'User searches or browses articles.', answerlattice: 'Widget can use safe page context, canonical answers, owner FAQ answers, related docs, or fallback.' },
            { label: 'Freshness', conventional: 'Maintained by manual docs work.', answerlattice: 'Drift and support gaps are visible review work.' },
        ...
        faq: [
            {
                ...
                answer: 'No. Hosted help and docs exist, but AnswerLattice is centered on support answer governance.',
            },
            {
