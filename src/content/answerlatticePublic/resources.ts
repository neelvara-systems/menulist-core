...
export const ANSWERLATTICE_RESOURCE_GROUPS: AnswerlatticeResourceGroup[] = [
    ...
    },
    {
        ...
        items: [
            { label: 'AnswerLattice Operating Guide', href: '/resources/answerlattice-operating-guide', description: 'Start as one founder, add team coordination when ownership spreads, and introduce deeper review controls only when risk grows.', eventName: 'resource_operating_guide_clicked' },
            ...
            { label: 'Feedback Review', href: '/resources/feedback-review-workflow', description: 'Plan how ratings, feature requests, and suggestions are grouped by product area before becoming private support follow-up.', eventName: 'resource_feedback_review_clicked' },
            { label: 'Support Board', href: '/resources/support-board-workflow', description: 'Plan private support cards, internal notes, status history, and draft-answer handoff.', eventName: 'resource_support_board_clicked' },
            ...
            { label: 'Security and runtime safety', href: '/resources/support-runtime-safety', description: 'Review tenant isolation, widget origin controls, screenshot input, compiled context boundaries, and owner approval.', eventName: 'resource_security_clicked' },
