...
export const ANSWERLATTICE_RESOURCE_ARTICLES: AnswerlatticeResourceArticle[] = [
    {
        ...
        metaDescription: 'A practical AnswerLattice checklist for preparing page-aware support before a SaaS or digital product launch.',
    ...
    },
    {
        ...
        description: 'Understand the AnswerLattice answer path: reviewed answers and owner Q&A first, fallback only when coverage is missing.',
        metaTitle: 'Approved Answers Before Fallback | AnswerLattice Resources',
        metaDescription: 'How AnswerLattice keeps approved page-aware support answers before fallback while making missing coverage reviewable.',
        ...
        primaryCta: { label: 'Review product governance', href: '/product/knowledge-governance' },
        ...
        sections: [
            {
                ...
                bullets: [
                    ...
                    'Published owner Q&A can answer short repeated questions.',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                body: [
                    'The public claim should stay manual-first: private cards, status history, selected follow-up, and governed handoff. Do not imply every signal automatically becomes a card or answer.',
                ],
            },
        ],
    },
    ...
    },
    {
        ...
        description: 'Understand how support credits fit governed answers, chat assistance, knowledge governance work, and static hosted help browsing.',
        ...
        quickAnswer: 'Support credits are plan capacity for governed support work. Static hosted help browsing and widget loading should not be described as per-view charges.',
        readingTime: '5 min read',
        publishedAt: '2026-06-02',
        updatedAt: '2026-06-02',
        priority: 0.66,
        ...
        sections: [
            {
                ...
                body: [
                    'Pricing copy should define support credits as plan capacity for governed answers, chat assistance, intake media processing, and knowledge governance work where applicable.',
                ],
            },
            {
                id: 'not-per-view',
            ...
            },
            {
                ...
                body: [
                    'Plan guidance should describe product stage, support volume, source preparation, and governance needs in plain language. Keep detailed billing operations inside the dashboard and pricing page.',
                ],
            },
        ],
    },
    {
        ...
        description: 'Plan docs, FAQs, changelog content, owner Q&A, support domains, and widget handoff for hosted help.',
        metaTitle: 'Hosted Help Setup | AnswerLattice Resources',
        metaDescription: 'How to plan AnswerLattice hosted help for docs, FAQs, changelog content, custom owner Q&A, support domains, and widget handoff.',
        quickAnswer: 'Hosted help should publish reviewed support knowledge and connect back to widget answers, fallback, and governance review.',
        readingTime: '6 min read',
        publishedAt: '2026-06-02',
        updatedAt: '2026-06-02',
        priority: 0.68,
        ...
        sections: [
            {
                ...
                checklist: [
                    ...
                    'Owner Q&A for short repeated questions.',
            ...
            },
            {
                ...
                body: [
                    'Hosted help is most useful when the same reviewed support truth can support page-aware widget answers and governance review.',
                ],
            },
        ],
    },
