...
export const ANSWERLATTICE_RESOURCE_ARTICLES: AnswerlatticeResourceArticle[] = [
    ...
    },
    {
        ...
        description: 'Understand how support credits fit reviewed answers, chat assistance, support review work, and static hosted help browsing.',
        ...
        quickAnswer: 'Support credits are plan capacity for reviewed support work. Static hosted help browsing and widget loading should not be described as per-view charges.',
        readingTime: '5 min read',
        publishedAt: '2026-06-02',
        updatedAt: '2026-06-02',
        priority: 0.66,
        ...
        sections: [
            {
                ...
                body: [
                    'Pricing copy should define support credits as plan capacity for reviewed answers, chat assistance, intake media processing, and support review work where applicable.',
                ],
            },
            {
                id: 'not-per-view',
