                        ...
                        <Flex gap={12} vertical>
                            ...
                            <Flex gap={8} vertical>
                                ...
                                <Flex align="center" justify="space-between" style={{ background: token.colorFillAlter, border: `1px solid ${token.colorBorderSecondary}`, borderRadius: 12, padding: '12px 14px' }}>
                                    ...
                                    <Switch aria-label="Transparent background" checked={imagePreferences.transparentBg || false} onChange={(transparentBg) => setImagePreferences((current) => ({ ...current, transparentBg }))} />
                                </Flex>
                                ...
                                <Flex align="center" justify="space-between" gap={12} style={{ background: token.colorFillAlter, border: `1px solid ${token.colorBorderSecondary}`, borderRadius: 12, opacity: imagePreferences.transparentBg ? 0.55 : 1, padding: '12px 14px' }}>
                                    <Flex gap={4} style={{ flex: 1, minWidth: 0 }} vertical>
	                                    ...
	                                    <Flex align="center" gap={8}>
	                                        ...
	                                        <Button aria-label="Clear background color" disabled={Boolean(imagePreferences.transparentBg) || !imagePreferences.backgroundColor} onClick={() => setImagePreferences((current) => ({ ...current, backgroundColor: null }))} size="small">
	                                            Clear
	                                        </Button>
                                    </Flex>
                                </Flex>
                                ...
                                <Flex align="center" justify="space-between" gap={12} style={{ background: token.colorFillAlter, border: `1px solid ${token.colorBorderSecondary}`, borderRadius: 12, padding: '12px 14px' }}>
                                    <Flex gap={4} style={{ flex: 1, minWidth: 0 }} vertical>
	                                    ...
	                                    <Flex align="center" gap={8}>
	                                        ...
	                                        <Button aria-label="Clear foreground color" disabled={!imagePreferences.foregroundColor} onClick={() => setImagePreferences((current) => ({ ...current, foregroundColor: null }))} size="small">
	                                            Clear
	                                        </Button>
                                    </Flex>
                                </Flex>
