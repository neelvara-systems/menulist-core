        ...
        <>
            <Modal
                ...
                footer={[
                    ...
                    <Button key="generate" type="primary" icon={<LuSparkles />} onClick={generateNewImageClick} disabled={uploadSuccess}>
