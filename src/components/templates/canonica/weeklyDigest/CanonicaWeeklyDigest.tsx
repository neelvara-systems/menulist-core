...
const STATUS_COLOR: Record<CanonicaActivationStep['status'], string> = {
    complete: 'success',
    attention: 'warning',
    pending: 'default',
    optional: 'processing',
...
export default function CanonicaWeeklyDigest() {
    ...
    if (!summary) {
        return (
            <Alert
                ...
                description="Refresh after Canonica activation summary is available for this workspace."
                ...
                <Col xs={24} lg={10}>
                    <Card title="Knowledge Health">
                        <Space direction="vertical" size={12} style={{ width: '100%' }}>
                            ...
                            <Button block onClick={() => openRoute(CANONICA_ROUTES.GOVERNANCE)}>
                                Open Governance
                            </Button>
                        </Space>
                    </Card>
