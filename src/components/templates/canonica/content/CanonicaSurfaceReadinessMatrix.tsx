...
type CanonicaSurfaceReadinessMatrixProps = {
    summary: CanonicaActivationSummary;
    isMobile?: boolean;
    onOpen: (route: string) => void;
};

const STATUS_META: Record<CanonicaSurfaceReadinessItem['status'], {
    label: string;
    color: string;
    ...
    ready: {
        ...
        actionRoute: CANONICA_ROUTES.PRODUCT_SURFACES,
    },
    needs_mapping: {
        label: 'Needs mapping',
        color: 'warning',
        icon: LuRouter,
        recommendation: 'Add route, feature, page, workflow, or entity signals so Canonica knows where this surface applies.',
    ...
    open_signals: {
        ...
        actionRoute: CANONICA_ROUTES.TICKETS,
    },
};

export default function CanonicaSurfaceReadinessMatrix({
    summary,
    isMobile = false,
    onOpen,
        ...
        >
            <Flex vertical gap={12}>
                ...
                {surfaces.length === 0 ? (
                    ...
                    >
                        <Button type="primary" onClick={() => onOpen(CANONICA_ROUTES.PRODUCT_SURFACES)}>
