...
const supportActions = [
    ...
    },
    {
        ...
        icon: LuTicket,
        route: ANSWERLATTICE_ROUTES.SUPPORT,
    },
    {
        key: 'release-notes',
        title: 'Release Notes',
        ...
        icon: LuReceipt,
        route: ANSWERLATTICE_ROUTES.RELEASE_NOTES,
    },
];

export default function AnswerlatticeClientHome() {
    ...
    return (
        <Flex vertical gap={20} style={{ width: '100%', maxWidth: 1180, margin: '0 auto' }}>
            <Flex vertical gap={4}>
                ...
                <Text type="secondary">Client support runs through Answerlattice.</Text>
            </Flex>
                ...
                {supportActions.map((action) => {
                    ...
                    return (
                        <Col key={action.key} xs={24} md={8}>
                            <Card
                                hoverable
                                onClick={() => router.push(toAnswerlatticeDashboardRoute(action.route, currentHostname))}
