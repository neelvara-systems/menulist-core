...
function AnswerlatticeLoaderLogo({
    ...
    const filter0Id = `${idPrefix}-filter0-d`;
    const filter1Id = `${idPrefix}-filter1-d`;
    const filter2Id = `${idPrefix}-filter2-f`;
    const filter3Id = `${idPrefix}-filter3-f`;
    const filter4Id = `${idPrefix}-filter4-f`;
    const filter5Id = `${idPrefix}-filter5-f`;
    const paint0Id = `${idPrefix}-paint0-linear`;
    const paint1Id = `${idPrefix}-paint1-linear`;
    ...
    return (
        ...
        >
            ...
            <g clipPath={`url(#${clipId})`}>
                ...
                <rect width="8366.47" height="5130.15" fill="white" />
                <rect width="8425.81" height="5130.15" fill="#0D0D0D" />
                <g filter={`url(#${filter0Id})`}>
                    <path
                        className={styles.leftStroke}
            ...
            <defs>
                ...
                <filter id={filter2Id} x="3620.9" y="3175.9" width="588.2" height="591.7" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <feGaussianBlur stdDeviation="13.05" result="effect1_foregroundBlur" />
                </filter>
