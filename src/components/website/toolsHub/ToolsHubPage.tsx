...
const TOOLS_HUB_GROUPS: ToolsHubGroup[] = [
  ...
  {
    key: 'printShareAssets',
    icon: LuPrinter,
    tools: [
      {
        href: '/tools/qr-poster-maker',
        key: 'qrPosterMaker',
        icon: LuQrCode,
        ownerPathKey: 'create',
      },
      {
        href: '/tools/whatsapp-menu-status-maker',
        key: 'whatsappMenuStatusMaker',
        icon: LuMessageCircle,
        ownerPathKey: 'create',
      },
      {
        href: '/tools/holiday-hours-poster-maker',
        key: 'holidayHoursPosterMaker',
        icon: LuCalendarClock,
        ownerPathKey: 'create',
      },
      {
        href: '/tools/customer-link-card-maker',
        key: 'customerLinkCardMaker',
        icon: LuLink,
        ownerPathKey: 'create',
      },
      {
        href: '/tools/feedback-qr-card-maker',
