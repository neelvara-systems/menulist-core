...
export const DB_COLLECTIONS = {
    ...
    EMAIL_OS_DELIVERIES: 'answerlattice_emailOsDeliveries',
    EMAIL_OS_WEBHOOK_RECEIPTS: 'answerlattice_emailOsWebhookReceipts',
    EMAIL_OS_SUPPRESSIONS: 'answerlattice_emailOsSuppressions',
    WHATSAPP_OS_MESSAGE_REFS: 'answerlattice_whatsappOsMessageRefs',
