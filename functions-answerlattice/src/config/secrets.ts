...
export const ANSWERLATTICE_SECRETS = {
    ...
    RESEND_API_KEY: defineOptionalProviderSecret('ANSWERLATTICE_RESEND_API_KEY'),
    RESEND_WEBHOOK_SECRET: defineOptionalProviderSecret('ANSWERLATTICE_RESEND_WEBHOOK_SECRET'),
...
export const ANSWERLATTICE_SECRET_GROUPS = {
    ...
    EMAIL_OS_WEBHOOK: bindOptionalProviderSecrets([
        ANSWERLATTICE_SECRETS.RESEND_WEBHOOK_SECRET,
    ]),
