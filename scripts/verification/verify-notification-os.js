...
const firingSources = {
  ...
  "AL:CREDITS_LOW": read("src/lib/answerlattice/aiAccounting.ts") + read("src/data/shared/creditNotificationPolicy.ts"),
  "AL:CREDITS_EXHAUSTED": read("src/lib/answerlattice/aiAccounting.ts") + read("src/data/shared/creditNotificationPolicy.ts"),
