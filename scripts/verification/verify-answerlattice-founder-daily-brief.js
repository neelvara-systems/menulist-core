...
assertIncludes(assistantLib, 'This brief uses saved support summaries and does not spend support credits.', 'brief owner-readable cost note');
assertIncludes(assistantLib, 'It only uses setup and support status already available in this workspace.', 'brief owner-readable source note');
assertNotIncludes(assistantLib, 'no new Firestore scan', 'brief hides implementation language from owners');
