...
assertIncludes(ownerDesktopCard, 'No external sites were scanned', 'Public Truth Check desktop boundary copy');
...
assertIncludes(ownerDesktopCard, 'Fix list', 'Public Truth Check desktop setup job copy');
...
assertIncludes(ownerDesktopCard, 'Public readiness', 'Public Truth Check desktop owner title');
assertIncludes(ownerMobileCard, 'No external sites scanned', 'Public Truth Check mobile boundary copy');
...
assertIncludes(ownerMobileCard, 'Fix list', 'Public Truth Check mobile setup job copy');
