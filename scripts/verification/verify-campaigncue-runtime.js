...
function verifyDocsAlignment() {
  ...
  assertIncludes(publicSite, "CampaignCueFitCheck", "CampaignCue public site exposes AdCreative-inspired fit check");
  ...
  assertIncludes(publicSite, "Pick the problem you recognize.", "CampaignCue fit check uses owner-bottleneck copy");
  assertIncludes(publicSite, "I need something useful to promote today.", "CampaignCue fit check covers daily cue bottleneck");
  assertIncludes(publicSite, "I want files and text, not connected posting.", "CampaignCue fit check preserves export-first boundary");
  ...
  assertIncludes(publicSite, "campaigncue-fit-check-list", "CampaignCue public site uses fit-check ledger");
