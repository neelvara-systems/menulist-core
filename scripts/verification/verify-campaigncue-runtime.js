...
function verifyDocsAlignment() {
  ...
  assertIncludes(publicSite, "Campaign proof deck", "CampaignCue public proof layer exposes campaign proof deck");
  assertIncludes(publicSite, "campaigncue-proof-deck-preview", "CampaignCue public proof layer renders proof deck preview");
  assertIncludes(publicSite, "Source trace", "CampaignCue public proof deck preview exposes source trace row");
  assertIncludes(publicSite, "Review checklist", "CampaignCue public proof deck preview exposes review checklist row");
  assertIncludes(publicSite, "Reusable pack templates", "CampaignCue public proof layer exposes reusable pack templates");
  assertIncludes(publicSite, "campaigncue-template-flow", "CampaignCue public proof layer renders reusable-template loop");
  assertIncludes(publicSite, "Reusable template loop", "CampaignCue public proof layer labels reusable-template loop");
  assertIncludes(publicSite, "Save the useful pack", "CampaignCue public template loop starts from saved pack");
  assertIncludes(publicSite, "Update the facts", "CampaignCue public template loop preserves source-fact update step");
  assertIncludes(publicSite, "Export again", "CampaignCue public template loop preserves export-first reuse step");
  assertIncludes(publicSite, "Disclosure and avoid-list checks", "CampaignCue public proof layer exposes UGC disclosure and avoid-list checks");
  assertIncludes(publicSite, "brand guidance, reusable pack", "CampaignCue public proof layer explains proof context");
  ...
  assertIncludes(publicSite, "CampaignCueProblemBand", "CampaignCue public site exposes owner-problem band");
  ...
  assertIncludes(publicSite, "CampaignAssetWall", "CampaignCue public site exposes campaign artifact wall");
  assertIncludes(publicSite, "Local marketing breaks before the post is written.", "CampaignCue owner-problem band uses owner-bottleneck copy");
  assertIncludes(publicSite, "Blank prompts waste the owner's time.", "CampaignCue owner-problem band covers blank-prompt bottleneck");
  assertIncludes(publicSite, "Direct posting is risky before trust is clear.", "CampaignCue owner-problem band preserves export-first boundary");
  ...
  assertIncludes(publicSite, "It should look like finished work, not another prompt page.", "CampaignCue public site rejects content-slop page feel");
  assertIncludes(publicSite, "Owners still review, export, and post manually.", "CampaignCue artifact wall preserves manual delivery boundary");
  ...
  assertIncludes(publicSite, "campaigncue-problem-band-grid", "CampaignCue public site uses owner-problem grid");
  ...
  assertIncludes(publicLayout, "themeColor: '#061a78'", "CampaignCue public layout browser theme color follows reference navy");
  assertNotIncludes(publicLayout, "import './styles.css';", "CampaignCue public layout avoids nested route CSS import");
  assertIncludes(publicStyles, "--cc-ink: #061a78", "CampaignCue public site uses reference navy palette token");
  ...
  assertIncludes(publicStyles, ".campaigncue-problem-band {\n    display: grid;\n    grid-template-columns: minmax(0, 1fr);", "CampaignCue owner-problem band keeps heading in a full-width stacked intro row");
  ...
  assertIncludes(publicStyles, "--cc-ink: #061a78", "CampaignCue mobile drawer keeps palette tokens after portal rendering");
  ...
  assertIncludes(websiteDoc, "proof deck preview", "CampaignCue website doc records proof deck preview");
  assertIncludes(websiteDoc, "reusable-template loop", "CampaignCue website doc records reusable-template loop");
