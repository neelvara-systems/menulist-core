...
const REQUIRED_CANONICAL_NAMES = [
  'MENULIST_BILLING_LEGAL_IDENTITY_VERIFIED',
  'MENULIST_BILLING_MERCHANT_ENTITY_ID',
  'MENULIST_BILLING_LEGAL_SUPPLIER_NAME',
  'MENULIST_BILLING_REGISTERED_ADDRESS',
  'MENULIST_BILLING_GSTIN',
  'MENULIST_BILLING_SUPPLIER_STATE_CODE',
  'MENULIST_BILLING_SAC_CODE',
  'MENULIST_BILLING_INTERNATIONAL_CHECKOUT_ENABLED',
  'MENULIST_BILLING_EXPORT_ZERO_RATING_ENABLED',
  'MENULIST_BILLING_LUT_REFERENCE',
  'MENULIST_BILLING_DOCUMENTS_ENABLED',
  'MENULIST_BILLING_DOCUMENT_DELIVERY_ENABLED',
  'MENULIST_BILLING_E_INVOICE_STATUS',
  'MENULIST_BILLING_AUTHORISED_SIGNATORY_NAME',
