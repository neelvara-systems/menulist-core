...
process.env.SIGNALDESK_FIREBASE_PROJECT_ID = process.env.SIGNALDESK_FIREBASE_PROJECT_ID
  || process.env.GCLOUD_PROJECT
  || "demo-signaldesk";
process.env.NEXT_PUBLIC_SIGNALDESK_FIREBASE_PROJECT_ID = process.env.NEXT_PUBLIC_SIGNALDESK_FIREBASE_PROJECT_ID
  || process.env.SIGNALDESK_FIREBASE_PROJECT_ID;
