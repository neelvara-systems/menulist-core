# AGENTS.md - Persistent Brain

**Version:** 1.0  
**Status:** 🔒 CRITICAL - System Memory Replacement  
...
This file serves as the **persistent brain** for Kilo Code, replacing Windsurf memory. Contains system decisions, architecture truths, and critical gotchas that must be remembered across all sessions.
