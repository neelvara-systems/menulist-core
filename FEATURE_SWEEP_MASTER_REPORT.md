...
- Canonical and `menulist.digital/ml` navigation is now consistent for FAQ, Tools, WhatsApp, Invite and reviewed localized Resources; header active state and language switching are alias-safe, and the language control has explicit accessible state/Escape focus return.
