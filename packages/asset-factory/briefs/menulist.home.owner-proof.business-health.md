# Asset Brief - menulist.home.owner-proof.business-health
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.home.owner-proof.business-health.md

## Intent

Show a fictional stable check with a clear no-action-needed state and no invented performance metrics.
...
- primary: webp, 4:3, max 110 KB

## Existing Files

- primary: public/images/website/product-proof/business-health-stable-check.webp
...
- Mobile required: yes
- Mobile max KB: 110
- Notes: Keep the stable state readable without implying guaranteed correctness or continuous monitoring.
...
- __docs__/main-website/asset-production/stage-08-product-proof/stage-08-product-proof-demo-assets.md: Stage 8 Product Proof Demo Asset Pack
- scripts/website-assets/generate-product-proof-assets.mjs: Source file
- src/components/website/home/OwnerProofSection.tsx: Source file
- src/components/website/features/BusinessHealthFeaturePage.tsx: Source file
