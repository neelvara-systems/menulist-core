# Asset Brief - menulist.marketing.launch-video.poster-placeholder
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.marketing.launch-video.poster-placeholder.md

## Intent

Retain a governed vertical planning placeholder until an approved walkthrough poster or thumbnail replaces it.
...
- primary: svg, 9:16, max 10 KB

## Existing Files

- primary: public/images/website/demo-placeholders/launch-video-poster-placeholder.svg
...
- Mobile required: yes
- Mobile max KB: 10
- Notes: Keep the planning-only label readable in a vertical preview.
