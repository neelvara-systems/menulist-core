...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.home.og.official-source.md

## Intent

Provide a share preview derived from the official-source homepage visual.
...
- fallback: png, 1200x630, max 500 KB

## Existing Files

- og: public/images/website/menulist-og-official-source.png
- fallback: public/og-image.png
