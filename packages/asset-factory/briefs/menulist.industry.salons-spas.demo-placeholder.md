# Asset Brief - menulist.industry.salons-spas.demo-placeholder
...
Show the shape of a fictional salon service-list page while routed demo screenshots remain pending.
...
- Mobile required: yes
- Mobile max KB: 10
- Notes: Keep the demo label and fictional-data boundary readable on narrow industry pages.
