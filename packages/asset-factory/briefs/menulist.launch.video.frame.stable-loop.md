# Asset Brief - menulist.launch.video.frame.stable-loop
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.launch.video.frame.stable-loop.md

## Intent

Show the public truth loop stabilizing without adding owner monitoring or unsupported sync claims.
...
- Destination: packages/asset-factory/published/menulist/launch-video-frames/03-stable-loop.png
...
- primary: packages/asset-factory/published/menulist/launch-video-frames/03-stable-loop.png
