# Asset Brief - menulist.feature.print-ready-kit.editor
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.feature.print-ready-kit.editor.md
...
- primary: jpg, 16:9, max 200 KB

## Existing Files

- primary: public/images/website/print-ready-kit/print-assets-editor.jpg
...
- Mobile required: yes
- Mobile max KB: 200
- Notes: The editor canvas and main controls must remain recognizable on a narrow feature page.
