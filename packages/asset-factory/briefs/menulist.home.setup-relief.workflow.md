# Asset Brief - menulist.home.setup-relief.workflow
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.home.setup-relief.workflow.md

## Intent

Show upload, review, and publish as a low-effort owner workflow.
...
- primary: webp, 16:9, max 220 KB

## Existing Files

- primary: public/images/website/menulist-setup-relief-workflow.webp
...
- src/components/website/home/SetupReliefSection.tsx: Source file
- src/components/templates/main-app/projects/jobScreens/ExtractionJobReviewScreen.tsx: Source file
