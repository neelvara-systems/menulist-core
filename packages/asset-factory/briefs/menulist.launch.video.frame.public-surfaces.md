# Asset Brief - menulist.launch.video.frame.public-surfaces
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.launch.video.frame.public-surfaces.md

## Intent

Show the approved source reaching the public menu, Official Business Page, QR, and screen surfaces.
...
- Destination: packages/asset-factory/published/menulist/launch-video-frames/02-public-surfaces.png

## Output Contract

- primary: png, 16:9, max 500 KB

## Existing Files

- primary: packages/asset-factory/published/menulist/launch-video-frames/02-public-surfaces.png
...
- scripts/website-assets/extract-menulist-launch-frames.mjs: Source file
- public/images/website/menulist-business-truth-loop.mp4: Source file
