# Asset Brief - menulist.industry.local-service-businesses.demo-placeholder
...
Show the shape of a fictional local-service rate card while routed demo screenshots remain pending.
...
- Mobile required: yes
- Mobile max KB: 10
- Notes: Keep the sample-business label and package hierarchy readable on mobile.
