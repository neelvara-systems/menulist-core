...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.home.hero.official-source.md

## Intent

Show MenuList as the official public source for menu and business truth.
