# Asset Brief - menulist.home.owner-proof.ai-menu-manager
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.home.owner-proof.ai-menu-manager.md

## Intent

Show a fictional message-to-prepared-card workflow with owner approval kept explicit.
...
- primary: webp, 4:3, max 100 KB

## Existing Files

- primary: public/images/website/product-proof/ai-menu-manager-approval-card.webp
...
- Mobile required: yes
- Mobile max KB: 100
- Notes: Keep owner approval visibly separate from the prepared suggestion on mobile.
...
- src/components/website/ai-menu-manager/AiMenuManagerPage.tsx: Source file
