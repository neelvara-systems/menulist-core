# Asset Brief - menulist.feature.print-ready-kit.dashboard
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.feature.print-ready-kit.dashboard.md

## Intent

Show the cropped print-assets template list with account-header details removed.
...
- primary: jpg, 4:3, max 220 KB

## Existing Files

- primary: public/images/website/print-ready-kit/print-assets-dashboard.jpg
...
- Mobile required: yes
- Mobile max KB: 220
- Notes: The template list must remain inspectable without exposing account or tenant details.
...
- src/components/website/features/PrintReadyKitProofGallery.tsx: Source file
- src/components/templates/main-app/printableAssetTemplates/PrintableAssetTemplatesRoute.tsx: Source file
