# Asset Brief - menulist.feature.qr-menu-links.share-kit
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.feature.qr-menu-links.share-kit.md

## Intent

Show the bounded owner share, QR, and presence controls used to distribute the approved link.
...
- primary: webp, 4:3, max 50 KB

## Existing Files

- primary: public/images/website/features/qr-menu-links/share-kit.webp
...
- Mobile required: yes
- Mobile max KB: 50
- Notes: Keep QR and share controls readable while preserving the owner-placement boundary.
...
- src/components/website/features/FeatureScreenshotProofGallery.tsx: Source file
- src/components/mobile/screens/MobileShareScreen.tsx: Source file
