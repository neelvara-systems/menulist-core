# Asset Brief - menulist.feature.customer-feedback-loop.public-form
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.feature.customer-feedback-loop.public-form.md

## Intent

Show the public feedback report form as a bounded customer workflow.
...
- primary: webp, 1:1, max 40 KB

## Existing Files

- primary: public/images/website/features/customer-feedback-loop/public-feedback-form.webp
...
- Mobile required: yes
- Mobile max KB: 40
- Notes: Keep form labels and the public-report context readable on mobile.
