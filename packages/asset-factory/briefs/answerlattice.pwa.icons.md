# Asset Brief - answerlattice.pwa.icons
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/answerlattice.pwa.icons.md
...
- primary: public/answerlattice-icon-512.png
- fallback: public/answerlattice-icon-maskable-512.png
- appleTouch: public/answerlattice-apple-touch-icon.png
- favicon16: public/answerlattice-favicon-16.png
- favicon32: public/answerlattice-favicon-32.png
- faviconIco: public/answerlattice-favicon.ico
- icon16: public/answerlattice-icon-16.png
- icon32: public/answerlattice-icon-32.png
- icon48: public/answerlattice-icon-48.png
- icon96: public/answerlattice-icon-96.png
- icon128: public/answerlattice-icon-128.png
- icon180: public/answerlattice-icon-180.png
- icon192: public/answerlattice-icon-192.png
- maskable192: public/answerlattice-icon-maskable-192.png
