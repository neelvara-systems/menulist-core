# Asset Brief - menulist.feature.public-discovery.presence-checklist
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.feature.public-discovery.presence-checklist.md

## Intent

Show the bounded placement/source checklist without implying automatic third-party distribution.
...
- primary: webp, 16:9, max 40 KB

## Existing Files

- primary: public/images/website/features/public-discovery/presence-checklist.webp
...
- Mobile required: yes
- Mobile max KB: 40
- Notes: Checklist labels must remain readable without suggesting automatic external sync.
