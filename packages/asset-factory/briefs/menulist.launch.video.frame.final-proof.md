# Asset Brief - menulist.launch.video.frame.final-proof
...
**Approval:** automatic
**Autonomy level:** 2
**Output file:** packages/asset-factory/briefs/menulist.launch.video.frame.final-proof.md

## Intent

Close on the calm final state where the approved public source remains in control.
...
- Destination: packages/asset-factory/published/menulist/launch-video-frames/04-final-proof.png
...
- primary: packages/asset-factory/published/menulist/launch-video-frames/04-final-proof.png
