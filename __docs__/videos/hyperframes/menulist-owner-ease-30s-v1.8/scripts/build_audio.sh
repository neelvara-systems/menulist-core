...
PREMASTER="$WORK_DIR/owner-ease-30s-v1.8-premaster.wav"
PASS1="$WORK_DIR/owner-ease-30s-v1.8-loudnorm-pass1.json"
PASS1_LOG="$WORK_DIR/owner-ease-30s-v1.8-loudnorm-pass1.log"
MASTER="$PROJECT_DIR/assets/mix/owner-ease-30s-v1.8-master.wav"
...
printf 'Created v1.8 audio master: %s\n' "$MASTER"
