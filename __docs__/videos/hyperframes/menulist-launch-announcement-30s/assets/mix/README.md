...
- Output duration: 30.000 seconds. Final MP4 duration check: 30.04 seconds.
...
ffmpeg -y \
  ...
  -filter_complex "[0:a]apad=pad_dur=12,atrim=0:30,asetpts=PTS-STARTPTS[voicepad];[0:a]volume=1.02,apad=pad_dur=12,atrim=0:30,asetpts=PTS-STARTPTS[voice];[1:a]atrim=0:30,asetpts=PTS-STARTPTS,afade=t=in:st=0:d=1.2,afade=t=out:st=28.4:d=1.6,volume=0.16[bgmquiet];[bgmquiet][voicepad]sidechaincompress=threshold=0.025:ratio=7:attack=40:release=450[ducked];[voice][ducked]amix=inputs=2:duration=first:normalize=0,atrim=0:30,asetpts=PTS-STARTPTS,loudnorm=I=-14:TP=-2:LRA=11[aout]" \
  -map "[aout]" \
  -ar 48000 \
