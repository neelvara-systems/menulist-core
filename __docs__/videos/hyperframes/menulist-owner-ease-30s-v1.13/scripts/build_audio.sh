...
PREMASTER="$WORK_DIR/owner-ease-30s-v1.13-premaster.wav"
PASS1="$WORK_DIR/owner-ease-30s-v1.13-loudnorm-pass1.json"
PASS1_LOG="$WORK_DIR/owner-ease-30s-v1.13-loudnorm-pass1.log"
MASTER="$PROJECT_DIR/assets/mix/owner-ease-30s-v1.13-master.wav"
...
printf 'Created v1.13 audio master: %s\n' "$MASTER"
