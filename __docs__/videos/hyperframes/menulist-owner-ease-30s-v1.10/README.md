...
[menulist-owner-ease-30s-v1.10.mp4](./deliverables/menulist-owner-ease-30s-v1.10.mp4)
...
- Encoded duration and size: 30.037 seconds, 6,532,973 bytes.
...
- The only intended visual change from `v1.8` is the simplified final brand signature.
- MP4 SHA-256: `287736f420566f6d420b6e6a08f0e0f578cbb057bf1b0cae84d700a6bc12d805`.
...
- Composition SHA-256: `b4ac132c05baadac726913e95dd7f86559f5ea1f7f2ff7b1c45b5f449f0f685a`.
...
npm run check
npx hyperframes render --skill=product-launch-video --output deliverables/menulist-owner-ease-30s-v1.10.mp4 --quality high --fps 30 --workers 1 --experimental-fast-capture=false
scripts/qa_video.sh deliverables/menulist-owner-ease-30s-v1.10.mp4
```
