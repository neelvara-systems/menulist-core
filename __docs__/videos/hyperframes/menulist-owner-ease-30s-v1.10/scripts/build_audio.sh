...
PREMASTER="$WORK_DIR/owner-ease-30s-v1.10-premaster.wav"
PASS1="$WORK_DIR/owner-ease-30s-v1.10-loudnorm-pass1.json"
PASS1_LOG="$WORK_DIR/owner-ease-30s-v1.10-loudnorm-pass1.log"
MASTER="$PROJECT_DIR/assets/mix/owner-ease-30s-v1.10-master.wav"
...
printf 'Created v1.10 audio master: %s\n' "$MASTER"
