...
| 7   | **Health Signals (Loyalty/Trust/Risk)** | —                                      | ✅ PARTIALLY BUILT                        | `HealthSignalCards.tsx`, feature flags, store types; official-link guidance is embedded in existing Dashboard/Share surfaces                                      |
