...
| 2 | Business Facts Copy Pack | Can I reuse the same public business facts across profiles, staff replies, and customer handoffs? | Business Health module checks MenuList identity, hours, location, contact, actions, and customer link | Monthly fact-copy report, multi-location copy consistency, agency export |
| 3 | QR Link Health Check | Does this QR code open the right current customer link? | Business Health module checks MenuList QR/share customer-link readiness | Recurring QR/location-table scan, monthly QR health report, branch-level QR audit |
| 4 | Menu / Service Readability Check | Can a customer quickly understand what is sold, prices, and how to act? | Business Health module checks MenuList project/menu/service truth for missing prices, vague categories, missing descriptions, and weak actions | Monthly clarity report, agency setup checklist, multi-location content consistency |
| 5 | Customer Question Coverage Check | Can the current source answer common customer questions? | Business Health module checks MenuList facts behind core answers | Recurring unanswered-question report, multi-location answer coverage, agency export |
| 6 | Customer FAQ Reply Pack | Can staff reuse clear FAQ answers from current facts? | Business Health module checks MenuList facts behind FAQ replies | Recurring FAQ consistency report, multi-location answer coverage, agency export |
| 7 | Booking Inquiry Readiness Check | Can customers clearly order, book, reserve, call, message, request a quote, or visit? | Business Health module checks MenuList action settings, contact, hours, location, and customer link | Recurring action-readiness report, multi-location action-link governance, agency export |
| 8 | Price & Availability Gap Check | Are prices, variants, unavailable items, and quote paths clear? | Business Health module checks MenuList item prices, variant prices, and availability flags | Monthly price/availability clarity report, multi-location consistency, agency export |
| 9 | Menu PDF Cleanup Check | Should an old PDF be replaced with one current customer link? | Business Health module checks MenuList source and customer-link readiness for PDF replacement | Monthly PDF cleanup report, multi-location PDF/source consistency, agency export |
| 10 | Google Profile Basics Checklist | Are owner-maintained Google Business Profile basics ready for customers? | Google profile handoff module checks MenuList customer-link readiness and owner-confirmed handoff state | Monthly profile-link readiness report, multi-location handoff export, agency setup report |
| 11 | WhatsApp Action Link Check | Can customers tap once to ask, book, order, or call? | Business Health module checks MenuList public page action links, WhatsApp number, call button, booking/order CTA | WhatsApp-ready customer-link pack, staff handoff templates, multi-location action-link governance |
| 12 | WhatsApp Reply Pack | Can staff reuse clear WhatsApp replies from current facts? | Business Health module checks WhatsApp/action, hours, menu/source, and customer-link facts | Staff handoff templates, recurring reply consistency, multi-location action-link governance |
| 13 | Hours & Holiday Hours Check | Are regular and special hours clear? | Business Health module checks MenuList store hours | Holiday readiness report, multi-location hours consistency |
| 14 | Photo / Visual Identity Gap Check | Does the public page have enough visual proof? | Business Health module checks logo, cover, storefront/item/service photos, and gallery readiness | Quarterly visual refresh checklist, agency/client export, multi-location photo coverage report |
| 15 | One Customer Link Preview | What will customers see when they open my business link? | Business Health module checks MenuList public-link readiness and core page facts | Recurring customer-link readiness report, multi-location preview export, agency setup report |
| 16 | Social Bio Link Consistency Check | Do my social bios and profile links point to the current customer link? | Business Health module checks one-current-link readiness for Share/Public Discovery handoff | Recurring profile-link consistency report, multi-location placement export, agency setup report |
