...
The shared strict phone/WhatsApp URL boundary and preview guard are browser-local and add no Firebase, Storage, Function, provider, DNS, or network operation.
