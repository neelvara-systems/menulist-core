...
| 8 | User sees "Retry Payment" button (links to Razorpay shortUrl) | `ActiveSubscriptionCard.tsx` | `<Button href={activeSubscription.shortUrl}>` |
...
| Step | What Happens | File | Key Code |
|------|-------------|------|----------|
| 1 | User clicks "Retry Payment" → opens Razorpay short URL in new tab | `ActiveSubscriptionCard.tsx` | `<Button href={activeSubscription.shortUrl} target="_blank">` |
