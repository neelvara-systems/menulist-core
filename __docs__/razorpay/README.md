...
- **Reconciliation:** Runs as the leased `subscription_reconciliation` task in `menulistMaintenanceScheduler` at 2:20 AM UTC via `functions/src/billing/reconcileSubscriptions.ts` — syncs Firestore ↔ Razorpay
