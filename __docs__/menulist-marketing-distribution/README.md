# MenuList Marketing Distribution

**Status:** Active operating docs  
**Created:** June 22, 2026  
**Owner:** Founder with Codex acting as MenuList marketing consultant  
**Scope:** MenuList marketing, launch, distribution, assets, channel strategy, and execution tracking only.

## Purpose

This folder is the working home for MenuList marketing and distribution.

It exists so every marketing decision, research source, ChatGPT input, consultant recommendation, asset requirement, and execution step stays in the repo instead of disappearing in chat.
...
| [MenuList launch strategy deep research](./launch-research-2026-09-03/report-source.md) | Canonical evidence-backed launch report comparing successful launch patterns, current X/Product Hunt/WhatsApp/disclosure rules, MenuList readiness, six launch gates, and the proof-compression launch sequence |
...
| Source | Use |
| --- | --- |
| [Captured ChatGPT conversation](../strategy/_archive/marketing-and-distribution-plan-chatgpt-conversation-2026-06-22.md) | Original 15-point marketing/distribution conversation |
| [MenuList Growth and Funnel Strategy](../marketing/menulist-growth-and-funnel-strategy.md) | Existing funnel, activation, subsidy, and 90-day plan |
| [MenuList Marketing README](../marketing/README.md) | Existing project-level marketing rules |
| [Main website repo-context synthesis](../main-website/website-prep-codex-prompts/stage-01-output-repo-context-synthesis.md) | Codebase-grounded product identity and proof surfaces |
| [Language Governance](../constitution/02-language-governance.md) | Required public, sales, support, and marketing language constraints |

## Consultant Rules

- Treat ChatGPT, outside sources, and competitor examples as inputs, not authority.
- Repo truth and shipped product surfaces decide what can be claimed.
- Do not market MenuList as "AI-powered", "smart", "dynamic", "growth hacking", or "QR menu software".
- Do not make revenue, ranking, conversion, or sales-lift claims without real proof.
...
MenuList should not start with a generic Product Hunt launch or paid campaign.
...
5. retire the expired August 11, 2026 Product Hunt target and select a new date only after the six gates in the launch deep-research report pass; readiness and response coverage outrank weekday folklore;
