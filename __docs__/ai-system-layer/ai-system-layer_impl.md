...
- Answerlattice RAG uses the shared versioned registry. Active v2 is `gemini-embedding-2` on `embeddingV2`; the legacy v1 field/index remain isolated for rollback until migration evidence is accepted.
