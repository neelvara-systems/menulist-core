...
- **Short-name deletion policy:** An explicitly cleared `pwaShortName` is written as a Firestore nested-field deletion. It must not be normalized into an omitted/no-op update, because owner UI and public manifest truth would otherwise diverge.
