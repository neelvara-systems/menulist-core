# Customer App — Marketing & Sales Collateral
...
> "Your customers can add your menu to their home screen as your branded app — not MenuList, yours. One tap access. Zero effort from you."
...
Restaurant owners know the pain:

- A customer loved the food, said "I'll be back"
- Next time they're hungry, they can't remember the restaurant's name
- They search "pizza near me" and find a competitor
- The original restaurant loses a repeat customer they earned

**The root cause:** No persistent presence on the customer's phone.
...
### MenuList vs. QR Code Competitors
...
**Headline:** "Your best customers forget how to find you."

**Body:**
- The average person has 80+ apps on their phone
- They remember 5-7 restaurants by name
- Everyone else competes for attention every single time
- Repeat customers are gold — but you lose them to friction

### Slide 2: Solution / How It Works

**Headline:** "Your menu becomes their app."
...
**Headline:** "While others rent you space, we give you presence."

**Body:**
- QR codes: Rented space on someone else's platform
- Delivery apps: Rented customers you pay commission for
- **MenuList Customer App: Your presence on their phone**

**The lock-in:** Once customers have your app, switching menu providers means explaining a new app to them. Natural retention without contracts.
...
**Headline:** "Let your menu become their app."

**Body:**
Every MenuList menu is already app-ready. Just toggle it on.

**CTA:** "Enable Customer App →"
...
**Primary message:**
> "Your menu becomes an app on your customers' phones. They tap, your menu opens. No searching, no links — just one tap."
...
- Position as "infrastructure" not "feature"
- Use "installable presence" language

### Regional Language Adaptations

**Hindi:**
- "अपना ऐप" (your own app)
- "एक टैप में मेनू" (menu in one tap)
- "घर की स्क्रीन पर" (on home screen)

**Spanish:**
- "Tu propia app" (your own app)
- "A un toque de distancia" (one tap away)
- "En la pantalla de inicio" (on home screen)

---

## Sales Talking Points

### Objection: "This is just a bookmark, right?"

**Response:**
> "No — it's stronger than a bookmark. A bookmark is buried in the browser. This is an app icon on their home screen, next to WhatsApp and Instagram. Customers see it every time they unlock their phone. That's presence, not a bookmark."

### Objection: "My customers aren't tech-savvy."

**Response:**
> "They don't need to be. We show them exactly what to do — 'Tap here, then tap Add.' If they can add a WhatsApp contact to their home screen, they can do this. And once it's done, using it is easier than anything — just tap the icon."

### Objection: "We already use Zomato/Swiggy for orders."

**Response:**
> "Those apps show you next to 100 other restaurants. Your Customer App shows only you. No competition, no commission, no algorithm deciding who sees your menu. Direct relationship with your customer."

### Objection: "Will this actually increase my sales?"

**Response:**
> "We don't promise revenue — we promise reduced friction. Every time a customer has to search, type, or remember, you risk losing them. The app removes all of that. Your repeat customers come back easier. That's the value."
...
| Approved Term | Why |
|---------------|-----|
| "Customer App" | Frames as product, not technology |
| "Your branded app" | Emphasizes ownership |
...
| Forbidden Term | Why | Replacement |
|----------------|-----|-------------|
| "PWA" | Technical jargon | "App" or "Customer App" |
...
| "Conversion" | SaaS jargon | "Repeat visits" |
...
**Frame:** Included with MenuList — no additional cost.

> "The Customer App is included with every MenuList subscription. There's no separate charge, no usage fee, no limit on installs. Every customer who adds your app — free."
...
Use this in pricing pages and feature comparisons:

| Surface | What It Does | Best For |
|---------|--------------|----------|
| **Digital Menu** | Live menu customers access via link/QR | First-time visitors |
| **PDF Menu** | Printable, shareable version | WhatsApp sharing, printing |
| **Digital Screens** | In-store display | Physical locations |
| **Official Page** | Public web presence | Google, social media |
| **Customer App** | **Installable app on customer phones** | **Repeat customers** |
...
- Position as "major differentiator" in competitive landscape
- Train sales on "Your own customer app" framing
- Prepare case studies from early adopters

### Launch (External)

**Website:**
> "New: Every business gets its own customer app"
...
- Track "% of stores with Customer App enabled"
- Collect testimonials about repeat customers
- Update sales deck with real numbers
