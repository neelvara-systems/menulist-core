...
_Document Status: Implementation-Complete (v3.7 — Preview page remains standalone/mobile-first. May 17 Firebase cost audit changed backend queue/event retention and dedup writes only; no new MobileShell screen needed.)_
