...
| G-05 | **Publish creates correct store data**         | Verify store document after publish                                                                                            | Store has: name, businessType (AI-detected actual type e.g. "Restaurant" — NOT "B2C"), businessCategory, email, phoneNumber, defaultLanguage, country/currency, active: true, roles, timeSlotPresets, tenantId, storeId, storeKey, isMaster: true, onboardingSource: 'MESSAGING_ONBOARDING', activationDeadline (24h from publish), public subdomain, logo: ''. | P0       |
