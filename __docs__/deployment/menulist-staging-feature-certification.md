...
| ML-QA-060 | Business Settings | All owner-controlled public business facts | Desktop and mobile | Auth and test project | Valid changes persist and invalid/cancelled changes do not mutate truth | Desktop loaded every scoped settings section. Required location/email and URL validation passed with exact Reset/reload recovery. Numeric boundary values clamped, persisted, then were explicitly cleared and remained at the original blank baseline after reload. External Menu Sync auto-persisted independently of page Reset and was restored to off after reload. Special Hours, Time Slot Presets, Locale time format, and Analytics customer-app tracking completed reversible lifecycle checks. Digital Screens, controlled-draft Reset, picker Enter, and preset accessibility defects are fixed under ML-QA-061 through 066. | IN PROGRESS | Controlled Chrome DOM through exact hosted `f105873`; focused Digital Screens, Guest Feedback, Business Settings Reset, working-hours/time-slot, public-business-truth, analytics-minimization, customer-app PWA, and contextual-state gates; MenuList localization source/runtime checks; lint; TypeScript | Bounded numeric save/clear, External Sync enable/disable, one Sunday-hours save/clear, one future Special Hours add/delete lifecycle, one preset create/edit/delete cascade lifecycle, one 12-hour/24-hour/12-hour locale lifecycle, and one Customer App analytics on/off/on lifecycle; fixed Enter proof performed no write; no provider ID/URL, provider test, delivery, screen, paid, or public-projection operation | Exact original location/email/link/numeric/feedback/social/locale/analytics values, all seven weekly days blank, no special dates, no time-slot presets, provider IDs blank, and External Sync off confirmed after fresh loads | `de56a3cfd80ce21a9e4c8f907d13b19490c7cf42`, `5a1020b0ac0955bf0552129d185285f5c59dd77d`, `8e561bdbdcf34997a67fe5e0642a5c2a4d8d3522`, `28c36c2c2ba8d61e44f948695cd63415aafc677f`, `a8a529756d28ee9e219817ddee87bb44128f2db2` | `f105873ce84a46d4080d2fe7056ade3cf3285efa` | Public projection, remaining independently saved settings families, mobile, and physical screen opens remain pending |
