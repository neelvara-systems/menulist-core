...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `aca6a6f7cf1192f6ff45d6ee535e7a4a6bea016e` reached hosted Preview with env `preview` at deployment `menulist-core-861ljaycc-neelvara-systems.vercel.app`; its only delta after certified runtime commit `8eb58c1dbbc997a4ef7f644fc47f629e96b19176` is verifier logic | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; visible Vercel Ready state; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-15 | None | None | `8eb58c1dbbc997a4ef7f644fc47f629e96b19176`, `aca6a6f7cf1192f6ff45d6ee535e7a4a6bea016e` | `aca6a6f7cf1192f6ff45d6ee535e7a4a6bea016e` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
