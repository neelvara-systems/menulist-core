...
| ML-QA-060 | Business Settings | All owner-controlled public business facts | Desktop and mobile | Auth and test project | Valid changes persist and invalid/cancelled changes do not mutate truth | Desktop loaded every scoped settings section. Required location/email and URL validation passed with exact Reset/reload recovery. Numeric boundary values clamped, persisted, then were explicitly cleared and remained at the original blank baseline after reload. External Menu Sync auto-persisted independently of page Reset and was restored to off after reload. Special Hours completed a reversible empty/add/reload/remove/reload lifecycle. Digital Screens, controlled-draft Reset, and picker Enter defects are fixed under ML-QA-061 through 064. | IN PROGRESS | Controlled Chrome DOM through exact hosted `28c36c2c2`; focused Digital Screens, Guest Feedback, and Business Settings Reset gates; lint; TypeScript | Bounded numeric save/clear, External Sync enable/disable, one Sunday-hours save/clear, and one future Special Hours add/delete lifecycle; fixed Enter proof performed no write; no provider URL, test, delivery, screen, paid, or public-projection operation | Exact original location/email/link/numeric/feedback/social values, all seven weekly days blank, no special dates, and External Sync off confirmed after reload | `de56a3cfd80ce21a9e4c8f907d13b19490c7cf42`, `5a1020b0ac0955bf0552129d185285f5c59dd77d`, `8e561bdbdcf34997a67fe5e0642a5c2a4d8d3522`, `28c36c2c2ba8d61e44f948695cd63415aafc677f` | `28c36c2c2ba8d61e44f948695cd63415aafc677f` | Public projection, remaining independently saved settings families, mobile, and physical screen opens remain pending |
