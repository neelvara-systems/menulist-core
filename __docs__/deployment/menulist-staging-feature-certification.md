...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `f0461c3177bd9a3fdab3a12135f7c84a1dd20f5c` reached hosted Preview with env `preview` at deployment `menulist-core-qr37mdby1-neelvara-systems.vercel.app` | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; `GET https://app.menulist.digital/api/version` on 2026-08-14 | None | None | `f0461c3177bd9a3fdab3a12135f7c84a1dd20f5c` | `f0461c3177bd9a3fdab3a12135f7c84a1dd20f5c` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
