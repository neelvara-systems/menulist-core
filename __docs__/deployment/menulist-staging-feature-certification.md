...
| ML-QA-009-PRICE | QA website / Price Availability Gap Check | Empty, missing-price variant gap, fixed-price readiness, quote-based readiness, malformed-link, copy/share, validation, reset, and evidence-truth lifecycle | Desktop Chrome | Public QA website; synthetic owner-pasted price and availability text only; no URL open, POS/inventory/provider check, download, or contact submission | Prices, units, variants, availability, quote/contact path, and customer link remain independently evidenced; absent variants never fabricate an owner selection; external systems stay not checked | Empty input returned `1 present / 2 missing / 0 unclear / 6 not checked` and `Price basics are missing`. A useful source naming small/medium/large packages but no prices returned `4 present / 1 missing / 2 unclear / 2 not checked`, with Price clarity missing and Variant/package prices unclear. Complete fixed-price text with variants, sold-out wording, contact path, and valid link returned `8 present / 0 missing / 0 unclear / 1 not checked`; quote-based services with a contact path and explicitly unneeded availability also returned the ready `8/0/0/1` summary. Replacing the public link with `not-a-url` returned `7 present / 0 missing / 1 unclear / 1 not checked`, with only Current customer link unclear and explicit no-open/no-fetch evidence. Copy and public-report-link actions announced success; name, work-email, and consent guards stopped handoff before submission. The original hosted empty report falsely said the owner had marked variant prices not needed even though no selection existed. On exact fixed Preview, empty input now says `No pasted source was provided for this fact.`, a useful source without variant wording says `No size, package, option, combo, or variant wording was found in the pasted text.`, and the stale owner-selection claim is absent in both branches. Final reset removed the report and cleared every control. | FIXED | Controlled hosted Chrome DOM before and after the repair; exact `/api/version` build `e8266280e2daa3b698400174b9c6e21492236b71`; immutable Preview `menulist-core-6aonqdbtd-neelvara-systems.vercel.app`; `verify:price-availability-gap-check`; `verify:public-truth-tools`; `test:public-truth-tools-runtime`; focused lint; TypeScript | None; pasted text, selections, and URL strings were evaluated locally and copy writes stayed browser-local; no URL request, external price verification, live inventory/POS/ordering-provider check, AI/search call, download artifact, POST, report persistence, Firebase, Storage, Functions, tenant, project, owner, or contact mutation | Final hosted reset returned `Report appears after the check`, removed the report, and left no checked readiness control or retained source text; optional handoff was never submitted | `e8266280e2daa3b698400174b9c6e21492236b71` | `e8266280e2daa3b698400174b9c6e21492236b71` | Successful consented handoff needs an authorized disposable lead and cleanup proof; download artifact and responsive/true-handheld rendering remain pending; external price verification, POS, inventory, ordering-provider, and AI/search checks remain intentionally outside V0 |
| ML-QA-009-PDF | QA website / Menu PDF Cleanup Check | Empty, current ready source, stale source, mobile-readability gap, QR/print dependency, malformed-link, copy/share, validation, reset, and evidence-truth lifecycle | Desktop Chrome | Public QA website; synthetic owner-entered PDF references and confirmations only; no upload, file/URL open, parse, OCR, download, or contact submission | Untouched defaults never prove a PDF source; current/readable/actionable facts can reach ready; date, mobile, dependency, and link gaps remain isolated; unconfirmed dependency facts never fabricate an owner selection | The original untouched hosted form returned `1 present / 3 missing / 4 unclear / 1 not checked`, falsely marking PDF source present from the default type and claiming owner-selected QR/print evidence although neither dependency checkbox was selected. A recent reference with mobile readability, copyability, prices, action, old-version removal, and a valid customer link returned `8 present / 0 missing / 0 unclear / 1 not checked` and `PDF source is ready to replace`. Older-than-three-months, missing mobile-readability, active QR/print dependency, and malformed-link paths each returned `7 present / 0 missing / 1 unclear / 1 not checked`, with only the relevant row unclear. The malformed link retained explicit no-open/no-fetch evidence. Copy and public-report-link actions announced success; name, work-email, and consent guards stopped handoff before submission. On exact fixed Preview, untouched input returns `0 present / 2 missing / 0 unclear / 7 not checked`, PDF source is Missing, the initial PDF type is `Not sure`, and no selected-source claim appears. A real PDF reference with neither dependency checkbox selected keeps QR/print dependency `Unclear` with `This fact was not provided by the owner.` rather than owner-selected evidence. Final reset restored the empty placeholder, `Not sure`, and zero checked controls. | FIXED | Controlled hosted Chrome DOM before and after the repair; exact `/api/version` build `46fb2aa12784926ea3a2c8fb6880ef6e54e87431`; immutable Preview `menulist-core-alkj1j0sh-neelvara-systems.vercel.app`; `verify:menu-pdf-cleanup-check`; `verify:public-truth-tools`; `test:public-truth-tools-runtime`; focused lint; TypeScript | None; references, selections, and URL strings were evaluated locally and copy writes stayed browser-local; no PDF upload/open/fetch/parse/OCR/store, URL request, QR scan, print inspection, AI/search call, download artifact, POST, report persistence, Firebase, Storage, Functions, tenant, project, owner, or contact mutation | Final hosted reset returned `Report appears after the check`, restored `Not sure`, cleared all values and six checkboxes, and removed the report; optional handoff was never submitted | `46fb2aa12784926ea3a2c8fb6880ef6e54e87431` | `46fb2aa12784926ea3a2c8fb6880ef6e54e87431` | Successful consented handoff needs an authorized disposable lead and cleanup proof; download artifact and responsive/true-handheld rendering remain pending; PDF upload/parsing/OCR, external page inspection, QR scans, print checks, and AI/search remain intentionally outside V0 |
| ML-QA-009-GOOGLE | QA website / Google Profile Basics Checklist | Empty, partial identity, required-gap threshold, complete readiness, malformed-link, copy/share, validation, and reset lifecycle | Desktop Chrome | Public QA website; synthetic owner-entered Google-profile self-report only; no Google login/open/fetch/inspection/update, download, or contact submission | Required profile basics remain independently evidenced; a name-match selection cannot replace missing identity text; valid links are format-checked locally; Google inspection always stays not checked | Empty input returned `0 present / 6 missing / 3 unclear / 1 not checked` and `Important profile basics are missing`. Entering only a city and selecting name-match returned `0 present / 5 missing / 4 unclear / 1 not checked`, with Business identity correctly `Unclear` because the business name remained absent. Leaving exactly Primary category, Current hours, and Menu/service link unconfirmed returned `6 present / 3 missing / 0 unclear / 1 not checked`, preserving the three-required-gap missing-basics threshold. Full identity, valid current link, and all nine owner confirmations returned `9 present / 0 missing / 0 unclear / 1 not checked` and `Profile basics look ready`, while Google inspection retained explicit Search/Maps/Business Profile/ranking/AI non-inspection evidence. Replacing the link with `not-a-url` returned `8 present / 0 missing / 1 unclear / 1 not checked`, with only Contact and website link unclear and explicit no-open/no-fetch evidence. Copy and public-report-link actions announced success. Handoff validation stopped successively at required name, valid email, and consent without submission. Reset cleared all values and nine checkboxes, removed the report, and restored the initial placeholder. | PASS | Controlled hosted Chrome DOM on exact application build `46fb2aa12784926ea3a2c8fb6880ef6e54e87431`; `verify:google-profile-basics-checklist`; `verify:public-truth-tools`; `test:public-truth-tools-runtime`; focused lint; TypeScript | None; owner-entered fields, confirmations, and URL strings were evaluated locally and copy writes stayed browser-local; no Google login/open/fetch/inspection/update, Search/Maps/ranking/review check, URL request, AI/provider call, download artifact, POST, report persistence, Firebase, Storage, Functions, tenant, project, owner, or contact mutation | Reset returned `Report appears after the checklist`, removed the report, and left no entered value or checked control; optional handoff was never submitted | None | `46fb2aa12784926ea3a2c8fb6880ef6e54e87431` | Successful consented handoff needs an authorized disposable lead and cleanup proof; download artifact and responsive/true-handheld rendering remain pending; Google login, profile verification/update, Maps/Search/review/ranking inspection, and external crawling remain intentionally outside V0 |
| ML-QA-009-FACTS | QA website / Business Facts Copy Pack | Empty placeholder pack, invalid-contact classes, complete deterministic pack, malformed-link exclusion, per-block/report/share copy, validation, reset, evidence-truth, and punctuation lifecycle | Desktop Chrome | Public QA website; synthetic owner-entered business facts only; no profile/link open, AI rewrite, external update, download, or contact submission | Required facts gate readiness; six blocks use only admitted facts plus explicit placeholders; invalid contacts/links never enter copy; punctuation is stable whether owner text already ends a sentence; external actions remain not checked | Empty input returned `1 present / 6 missing / 2 unclear / 1 not checked` and rendered six explicitly provisional copy blocks. Each invalid contact class (`call`, `WhatsApp`, and digit strings mixed with letters) stayed `Contact path: Missing` at `8 present / 1 missing / 0 unclear / 1 not checked`. Complete identity, offer, description, hours, location, valid phone, current link, and action link returned `9 present / 0 missing / 0 unclear / 1 not checked` and `Copy pack is ready`. Replacing the current link with `not-a-url` returned `8 present / 0 missing / 1 unclear / 1 not checked`; the malformed string was absent from all six generated blocks. Per-block, full-report, and public-report-link copy actions announced success; name, valid-email, and consent guards stopped handoff before submission. The original hosted empty fallback produced `action..` in two blocks and claimed copy came only from owner-entered facts although placeholders were present; complete owner descriptions ending in punctuation exposed an additional `description..` path. The maintained spec/validation contract, evidence text, and deterministic builder were corrected in `355919c77` and `2aad9b196`. On exact fixed Preview, empty and punctuation-heavy complete packs contain no double period; all six blocks say `Copy uses owner-entered facts and explicit missing-fact placeholders only. No AI rewrite was generated.`; the stale claim is absent. Final reset removed the pack and cleared all inputs. | FIXED | Controlled hosted Chrome DOM before and after both repairs; exact `/api/version` build `2aad9b196acda8f7b6ad82b5c7b928db55e414a2`; immutable Preview `menulist-core-kzoe0l2ys-neelvara-systems.vercel.app`; `verify:business-facts-copy-pack`; `verify:public-truth-tools`; `test:public-truth-tools-runtime`; focused lint; TypeScript | None; facts, phone/link shapes, and copy assembly stayed browser-local; no profile/URL request, platform inspection/update, AI rewrite/search call, report persistence, download artifact, POST, Firebase, Storage, Functions, tenant, project, owner, or contact mutation | Final hosted reset returned `Copy pack appears after the check`, removed the report, and cleared all entered values; optional handoff was never submitted | `355919c77`, `2aad9b196` | `2aad9b196acda8f7b6ad82b5c7b928db55e414a2` | Successful consented handoff needs an authorized disposable lead and cleanup proof; download artifact and responsive/true-handheld rendering remain pending; profile inspection/update, external crawling, AI rewrite/search, and ranking promises remain intentionally outside V0 |
