...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `22b85707900e12f487cd83de4c75d6eb5fce97ff` reached hosted Preview with env `preview` at deployment `menulist-core-aeh1c0z7t-neelvara-systems.vercel.app`; staging alias `/api/version` reported the same full commit before final hosted App Settings cross-tab/fullscreen certification | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; visible Vercel Ready state; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-15 | None | None | `22b85707900e12f487cd83de4c75d6eb5fce97ff` | `22b85707900e12f487cd83de4c75d6eb5fce97ff` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
