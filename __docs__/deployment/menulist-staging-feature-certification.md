...
| ML-QA-060 | Business Settings | All owner-controlled public business facts | Desktop and mobile | Auth and test project | Valid changes persist and invalid/cancelled changes do not mutate truth | Desktop loaded every scoped settings section. Required location/email and URL validation passed with exact Reset/reload recovery. Numeric boundary values clamped, persisted, then were explicitly cleared and remained at the original blank baseline after reload. External Menu Sync auto-persisted independently of page Reset and was restored to off after reload. Digital Screens and controlled-draft Reset defects are fixed under ML-QA-061/062/063. | IN PROGRESS | Controlled Chrome DOM through exact hosted `8e561bdbd`; focused Digital Screens, Guest Feedback, and Business Settings Reset gates; lint; TypeScript | Bounded numeric save/clear, External Sync enable/disable, and one Sunday-hours save/clear during verification; no provider URL, test, delivery, screen, paid, or public-projection operation | Exact original location/email/link/numeric/feedback/social values, all seven weekly days blank, and External Sync off confirmed after reload | `de56a3cfd80ce21a9e4c8f907d13b19490c7cf42`, `5a1020b0ac0955bf0552129d185285f5c59dd77d`, `8e561bdbdcf34997a67fe5e0642a5c2a4d8d3522` | `8e561bdbdcf34997a67fe5e0642a5c2a4d8d3522` | Public projection, remaining independently saved settings families, mobile, and physical screen opens remain pending |
