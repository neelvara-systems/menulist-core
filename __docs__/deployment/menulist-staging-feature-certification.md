...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `160adb94425bd4754f3ea604f9bb23c86aab9fc2` reached hosted Preview with env `preview` at deployment `menulist-core-93v4boct6-neelvara-systems.vercel.app` | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; GitHub/Vercel deployment success; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-14 | None | None | `160adb94425bd4754f3ea604f9bb23c86aab9fc2` | `160adb94425bd4754f3ea604f9bb23c86aab9fc2` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
