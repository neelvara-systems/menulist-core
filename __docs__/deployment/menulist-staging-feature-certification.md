...
| ML-QA-060 | Business Settings | All owner-controlled public business facts | Desktop and mobile | Auth and test project | Valid changes persist and invalid/cancelled changes do not mutate truth | Desktop loaded every scoped settings section. Required location/email and URL validation passed with exact Reset/reload recovery. Numeric boundary values clamped, persisted, then were explicitly cleared and remained at the original blank baseline after reload. External Menu Sync auto-persisted independently of page Reset and was restored to off after reload. Digital Screens and Guest Feedback Reset defects are fixed under ML-QA-061/062. | IN PROGRESS | Controlled Chrome DOM through exact hosted `5a1020b0a`; focused Digital Screens and Guest Feedback gates, lint, TypeScript | Bounded numeric save/clear and External Sync enable/disable only; no provider URL, test, delivery, screen, paid, or public-projection operation | Exact original location/email/link/numeric/feedback values and External Sync off state confirmed after reload | `de56a3cfd80ce21a9e4c8f907d13b19490c7cf42`, `5a1020b0ac0955bf0552129d185285f5c59dd77d` | `5a1020b0ac0955bf0552129d185285f5c59dd77d` | Public projection, remaining settings families, mobile, and physical screen opens remain pending |
