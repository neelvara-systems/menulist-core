...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one commit | Latest application/ledger source `aa3333a25014001fce86ebaa4632d50510e3b611` reached hosted Preview with env `preview`; the following evidence-only ledger commit does not change runtime files | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; public GitHub Vercel commit status; `GET https://app.menulist.digital/api/version` on 2026-08-14 | None | None | `aa3333a25014001fce86ebaa4632d50510e3b611` | `aa3333a25014001fce86ebaa4632d50510e3b611` | Future application edits require a new exact-build gate |
...
| ML-QA-100 | Settings/Support/PWA | Help, app settings, locale, theme, offline/reload, accessibility | Desktop and mobile | Core owner flows available | State inherits correctly and recovery paths are usable | Help shell, search, support entries, recent-viewed state, footer, and navigation rendered. Category/article/changelog reads settled to honest empty content. The failed ticket-summary DAL request now remains visible and retryable on exact hosted QA. | IN PROGRESS | Controlled Chrome DOM/console on exact hosted `aa3333a25`; Help Center verifier, lint, TypeScript, contextual-state gate | None | None | `12376cf3f1957c6d8df388bb701619f8c4564adb`, `206c9621b5df5b24ec8d1c070241142bbfb1ce16` | `aa3333a25014001fce86ebaa4632d50510e3b611` | Search/ticket mutations, app settings/theme, mobile, offline and physical-device PWA remain pending |
