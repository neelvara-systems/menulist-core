...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `1145cc136c7ecd818cdfe0bca02cec31d36d13eb` reached hosted Preview with env `preview` at deployment `menulist-core-7porrvmdl-neelvara-systems.vercel.app` | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; visible Vercel Ready state; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-15 | None | None | `1145cc136c7ecd818cdfe0bca02cec31d36d13eb` | `1145cc136c7ecd818cdfe0bca02cec31d36d13eb` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
