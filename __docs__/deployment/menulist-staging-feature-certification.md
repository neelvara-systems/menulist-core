...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `2262a2aa4a79529c105b2c6615eb58b2967df05d` reached hosted Preview with env `preview` at deployment `menulist-core-47juq06q9-neelvara-systems.vercel.app`; staging alias `/api/version` reported the same full commit before final hosted Social Media certification | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; visible Vercel Ready state; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-15 | None | None | `ebb6e57bd6addbbdec9f093f503f593375d03b9b`, `5a06e5298e6f378c18bc1dd2d934e2d65841739c`, `2262a2aa4a79529c105b2c6615eb58b2967df05d` | `2262a2aa4a79529c105b2c6615eb58b2967df05d` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
