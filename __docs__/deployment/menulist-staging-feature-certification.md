...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `eec7b3dc07ed82b63b2fd54213c290835f47baa5` reached hosted Preview with env `preview` at deployment `menulist-core-5tomkuo5i-neelvara-systems.vercel.app` | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; visible Vercel Ready state; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-14 | None | None | `eec7b3dc07ed82b63b2fd54213c290835f47baa5` | `eec7b3dc07ed82b63b2fd54213c290835f47baa5` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
...
| ML-QA-060 | Business Settings | All owner-controlled public business facts | Desktop and mobile | Auth and test project | Valid changes persist and invalid/cancelled changes do not mutate truth | Desktop loaded every scoped settings section. Required location/email and URL validation passed with exact Reset/reload recovery. Numeric values, External Sync, Special Hours, Time Slot Presets, Locale time format, Analytics customer-app tracking, Guest Feedback enablement, and Business Attributes completed reversible lifecycle checks. Digital Screens, controlled-draft Reset, picker Enter, preset accessibility, Guest Feedback accessibility, Temporary Status expiry-timezone, and Business Attributes accessibility defects are fixed under the focused child rows. | IN PROGRESS | Controlled Chrome DOM through exact hosted `eec7b3dc`; focused Digital Screens, Guest Feedback, Temporary Status, Business Settings Reset, working-hours/time-slot, public-business-truth, analytics-minimization, customer-app PWA, mobile shell, public-customer localization, and contextual-state gates; lint; TypeScript | Bounded numeric save/clear, External Sync enable/disable, one Sunday-hours save/clear, one future Special Hours add/delete, one preset create/edit/delete, one locale lifecycle, one Customer App analytics lifecycle, one Guest Feedback on/off/on lifecycle, and one Business Attribute off/on/off lifecycle; no Temporary Status, provider ID/URL, provider test, delivery, screen, paid, public-form submission, or public-projection operation | Exact original location/email/link/numeric/feedback/social/locale/analytics values, all 17 Business Attributes off with no custom rows, all seven weekly days blank, no special dates, no time-slot presets, no active Temporary Status, provider IDs/review URL blank, and External Sync off confirmed after fresh loads | `de56a3cfd80ce21a9e4c8f907d13b19490c7cf42`, `5a1020b0ac0955bf0552129d185285f5c59dd77d`, `8e561bdbdcf34997a67fe5e0642a5c2a4d8d3522`, `28c36c2c2ba8d61e44f948695cd63415aafc677f`, `a8a529756d28ee9e219817ddee87bb44128f2db2`, `160adb94425bd4754f3ea604f9bb23c86aab9fc2`, `e9edc4425388e2c465af6e62bd8c638fbc2282d5`, `eec7b3dc07ed82b63b2fd54213c290835f47baa5` | `eec7b3dc07ed82b63b2fd54213c290835f47baa5` | Temporary Status set/clear, customer public projection, remaining settings families, true handheld mobile, and physical screen opens remain pending |
| ML-QA-060-TEMP | Business Settings / Temporary Status | Exact-expiry timezone agreement | Desktop Chrome plus source-gated mobile parity | QA owner `2/2`; no active status; active app timezone differs from the browser-system interpretation used by the preceding desktop picker | The visible expiry field, customer preview, confirmation, and persisted instant share the active app timezone | Preceding hosted build showed `Aug 15, 2026 10:00 PM` in the picker and `15 Aug 2026 04:30 pm` in its preview. Exact fixed build showed `Aug 15, 2026 5:00 PM` and `15 Aug 2026 05:00 pm`, respectively. The set confirmation could not be activated by the controlled Chrome layer, so persistence is not claimed. | FIXED | Exact `/api/version` build `e9edc442`; immutable Preview and staging alias; controlled hosted DOM and screenshot; `verify:temporary-status-boundary`; `verify:public-business-truth`; `verify:mobile-shell-route-map`; focused lint; TypeScript; docs links | None | Reload confirmed no active status and restored the default Closed Today draft | `e9edc4425388e2c465af6e62bd8c638fbc2282d5` | `e9edc4425388e2c465af6e62bd8c638fbc2282d5` | Authenticated set/independent-load/clear/independent-load, public projections, exact-expiry observation, and true handheld MobileShell remain pending |
...
| ML-QA-063 | Business Settings / Social Media / Working Hours | Cancelled parent-controlled drafts and page-level Reset | Desktop Chrome | QA owner `2/2`; persisted Instagram blank and all weekly days closed | Reset restores social URLs and weekly hours from store truth and clears hours dirty tracking; independently persisted panels remain untouched | Preceding hosted bundle left a test Instagram URL after Reset. Exact fixed build restored it to blank immediately. A blur-only Sunday-hours draft Reset to blank, and reload retained all seven blank days. | FIXED | Exact `/api/version`; controlled hosted DOM on `8e561bdbd`; `verify:business-settings-reset-boundary`; `verify:guest-feedback-boundary`; focused lint; TypeScript; docs links | First hours interaction submitted Sunday `09:00 AM`-`05:00 PM`; it was cleared and saved. Final Social Media/hours Reset verification performed no write. | Instagram blank and all seven weekly days blank confirmed after cleanup and again after no-write Reset/reload | `8e561bdbdcf34997a67fe5e0642a5c2a4d8d3522` | `8e561bdbdcf34997a67fe5e0642a5c2a4d8d3522` | Independently persisted settings, public projection, and true handheld behavior remain under ML-QA-060 |
...
- ML-QA-060-TEMP still requires authenticated set/clear persistence. Controlled
  Chrome exposed and focused the enabled action but did not activate its
  confirmation; no store write was fabricated.
- ML-QA-101 successful ticket-summary data still requires authorized
  Answerlattice QA backing data. ML-QA-031's successful empty Feedback read is
  now complete.
