...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `e9edc4425388e2c465af6e62bd8c638fbc2282d5` reached hosted Preview with env `preview` at deployment `menulist-core-c7lle0zj0-neelvara-systems.vercel.app` | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; visible Vercel Ready state; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-14 | None | None | `e9edc4425388e2c465af6e62bd8c638fbc2282d5` | `e9edc4425388e2c465af6e62bd8c638fbc2282d5` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
