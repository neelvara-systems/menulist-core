...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `89b1b7d09b56199cfdc7aa22e9b970720df9762e` reached hosted Preview with env `preview` at deployment `menulist-core-owzc87fnr-neelvara-systems.vercel.app` | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; visible Vercel Ready state; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-15 | None | None | `89b1b7d09b56199cfdc7aa22e9b970720df9762e` | `89b1b7d09b56199cfdc7aa22e9b970720df9762e` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
