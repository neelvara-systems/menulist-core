...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ML-QA-000 | Deployment | Exact source/host alignment | HTTP | `staging` checkout | Runtime source, remote, and hosted Preview report one application commit | Latest application source `cc092ba8e2b6a3812122fa54eddda224661edd95` reached hosted Preview with env `preview` at deployment `menulist-core-lo535xptn-neelvara-systems.vercel.app` | PASS | `git rev-parse HEAD`; `git rev-parse origin/staging`; visible Vercel Ready state; immutable Preview and `GET https://app.menulist.digital/api/version` on 2026-08-14 | None | None | `cc092ba8e2b6a3812122fa54eddda224661edd95` | `cc092ba8e2b6a3812122fa54eddda224661edd95` | The following evidence-only ledger commit does not change application runtime; future application edits require a new exact-build gate |
