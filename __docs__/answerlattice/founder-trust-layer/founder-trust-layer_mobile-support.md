...
Critical trust alerts are not part of the active v1 mobile scope. If this becomes necessary, add an Answerlattice-native notification design rather than relying on archived workflow integrations.
