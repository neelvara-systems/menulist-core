...
The public website can now mention the implemented day-one intake flow:

- Teach Answerlattice / knowledge intake command center
- selected public product/docs URLs
- pasted docs, FAQs, release notes, setup notes, and support macros
- repeated replies founders already send
- browser-extracted TXT, Markdown, CSV, JSON, DOCX, and text-based PDF content
...
Do not claim native private connectors, inbox sync, unlimited crawling, retained raw media, hidden background retries, or automatic canonical-answer publishing. Website copy can mention screenshot OCR and short media transcription only with limits, support-credit charging, and owner-review wording.
...
Teach Answerlattice your product from selected links, docs, files, screenshots, short recordings, FAQs, release notes, setup notes, support macros, and repeated replies. Generate source-backed support drafts with owner approval.
...
Paste your product link, choose the support-worthy pages Answerlattice finds, and add any docs, files, screenshots, release notes, repeated replies, or short recordings you already have. Answerlattice prepares source-backed help articles, FAQs, product-surface suggestions, and canonical answer proposals for owner review.
...
Implemented through the homepage support-knowledge map, first-session setup, day-one launch pack, trust section, and product feature grid.
...
1. **Add sources** — Product website, selected public pages, docs, supported files, screenshots, short recordings, FAQs, release notes, setup notes, support macros, and repeated replies.
2. **Review drafts** — Answerlattice groups KB, FAQ, product-surface, and answer-proposal drafts.
...
Real intake processing requires an active Answerlattice beta or subscription so Firebase usage stays bounded.
...
Current public pricing copy should say:

Section title:

**Credits keep support capacity predictable.**

Copy:

Support credits cover AI-assisted answers, fallback handling, governance work, and paid knowledge-intake media extraction such as screenshot OCR or short recording transcription. Public help pages, selected text import, and normal widget loading do not use credits.
...
Current public onboarding remains self-service beta/subscription setup:
...
Sign in, add the app, invite the right team members, pick the pages where users get stuck, and teach Answerlattice from selected links, docs, supported files, screenshots, short recordings, starter policy answers, and support exports.

First-session checklist:

- create workspace
- add product website and app URL
- add docs/files/screenshots/recordings if available
...
**Will Answerlattice publish generated answers automatically?**

No. Answerlattice can draft help articles, FAQs, and approved-answer candidates, but owner approval is required before authoritative answers go live.

**Can I upload video or screenshots?**

Yes, with limits. Screenshots are treated as evidence and should not contain secrets. Answerlattice extracts support text from screenshots and short recordings, records support-credit usage, and stores the extracted source text for owner review instead of retaining raw media.

**Why do I need to pay before import?**

Real import can use AI processing, parsing, and Firebase infrastructure. Active beta/subscription gating plus support-credit logging prevents surprise cost and keeps the product sustainable.
