# Answerlattice Pre-Onboarding Input Kit — Agent Guide

## Purpose

This guide defines how an AI coding agent should behave when a product owner gives it the Answerlattice pre-onboarding prompt or public guide link.
...
The agent prepares a source-backed input package for Answerlattice. It does not publish official support answers, replace support, or decide legal/security/billing truth.
...
If Answerlattice Knowledge Intake limits, source shape, payload fields, live-support gates, or website onboarding pages change, update:
