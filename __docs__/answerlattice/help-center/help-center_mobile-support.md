...
**Updated 2026-05-19:** Platform admin features are available to `PLATFORM` users from MenuList Mobile More -> Answerlattice. This does not replace the owner-facing Help Center mobile flow; it adds operator access for support recovery and emergency admin work.
...
| Widget Management | Yes | Same `AnswerlatticeWidgetManagement` template with embedded mobile mode |
