# Answerlattice — Infrastructure Readiness Certification (IRC v1.0)
...
- [ ] 5.2 All required query/vector indexes support the Answerlattice `tId` + `sId` tenant/store access pattern
