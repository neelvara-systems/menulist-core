# Answerlattice — Non-Goals Charter (Binding)
...
This document explicitly defines what Answerlattice will NOT become. Non-goals protect focus more than goals. Infrastructure products die from scope creep, not bugs.

---

## I. Answerlattice Is NOT a Helpdesk

Answerlattice will NOT:
...
**Rule:** Answerlattice governs knowledge behind support systems. It does not become the support system.
...
## II. Answerlattice Is NOT a Documentation CMS
...
**Rule:** Answerlattice governs structured truth. Presentation layer is secondary and minimal.
...
## III. Answerlattice Is NOT an AI Autopilot
...
## IV. Answerlattice Is NOT a Compliance / GRC Platform
...
## V. Answerlattice Is NOT a Business Analytics Platform
...
## VI. Answerlattice Will Not Break Core Invariants

Under no circumstances will Answerlattice:
...
## VII. Answerlattice's Only Expansion Axis

Answerlattice may expand only along:
- Ontology depth
...
Positioning must always reflect: **Governed Answer Infrastructure.**
