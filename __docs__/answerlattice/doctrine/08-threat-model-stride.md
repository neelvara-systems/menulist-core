# Answerlattice — Formal Threat Model (STRIDE)
...
**Existing pattern:** `platformRole` check for platform admin pages. Must extend to Answerlattice-specific roles.

**RBAC Matrix (Future — When Answerlattice Pillars Implemented):**
