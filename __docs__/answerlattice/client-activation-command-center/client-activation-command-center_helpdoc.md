# Help Doc: Launching Answerlattice
...
Use the four setup groups from top to bottom. Answerlattice opens the first group that still needs work:

1. **Add product knowledge:** confirm the workspace, current plan, and product profile; add reviewed help content; and map the initial Product Pages & Flows.
2. **Approve your first answers:** prepare the First 10 questions, review the relevant Product Topics, and approve only supported Trusted Answers.
