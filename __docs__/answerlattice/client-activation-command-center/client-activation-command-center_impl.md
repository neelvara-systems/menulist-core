...
1. **Add product knowledge** - workspace/current-plan evidence, product profile, bounded knowledge import/help content, and Product Surfaces.
2. **Approve your first answers** - the First 10, reviewed product entities, and active canonical answers.
