...
| Activation Command Center | `/product/launch-setup`, `/get-started` | `/answerlattice/activation`, `src/app/(answerlattice)/answerlattice/activation/page.tsx` | First-client launch proof, product profile, knowledge import, surfaces, widget install, governance summaries, signal-source checks |
