...
commented mounts for intentional one-line reactivation; they must not be
silently deleted or rendered alongside the current compressed path. Full
inventory, architecture, and feature details belong on Product, capability,
resource, security, and comparison pages.
...
| `/resources/founder-launch-kit` | Founder Support Launch Kit \| AnswerLattice | Prepare sources, define ten priority questions, approve answer routes, test, verify the widget, and measure explicit resolution. |
...
| 2026-07-16 | 1.2.36 | Added the homepage First Trusted Answers decision path, public Founder Launch Kit, tool-specific pre-onboarding wrappers, consent-gated proof rendering, and explicit resolution wording without adding website Firebase work |
