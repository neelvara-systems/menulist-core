...
and `https://www.canonica.app` are attached only to the Vercel custom `qa`
environment and serve the noindex QA surface. They must not be promoted to
production canonical copy or attached to Vercel Production.
