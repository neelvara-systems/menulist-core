...
Dashboard packet/ZIP: one store read per admitted owner-triggered packet or ZIP request. The July 19 hardening changed quota isolation, cache/content-type headers, generated-output bounds, and browser acknowledgement only; it added no Firebase operation.
