# Answerlattice — Founder Onboarding (Knowledge Bootstrap Engine) — Help Documentation
...
Answerlattice automatically bootstraps your AI support system from your existing documentation. Here's how it works.

---

## Step 1: Upload Your Documentation

Go to your Answerlattice dashboard → **KB Generation** → **New Import**.
...
Answerlattice's AI processes your uploaded files and generates structured help articles. This typically takes 2-5 minutes depending on the amount of content.
...
After publishing, Answerlattice automatically:
...
Upload your current docs. You can always update articles later, and Answerlattice will detect changes and suggest updates.
