...
> Ask what support knowledge needs review, see the evidence, and move to the right review workflow.
...
> Owner Support Assistant for SaaS Support Review | Answerlattice

Potential description:

> Review support gaps, weak answers, and next actions from one private Answerlattice workspace without bypassing governed answer approval.
