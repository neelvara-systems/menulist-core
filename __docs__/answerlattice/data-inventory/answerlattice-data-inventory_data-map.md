...
| `answerlattice_signalEvents` | Public API signals and internal ticket/chat/feedback/escalation signals: type, entity id, sanitized metadata, timestamp, actor trace. | Signal emitter, public signal ingestion, ticket/feedback/chat flows. | Mutation governance, friction aggregation, support board, predictive help. | Evidence, not automatic authority. | Existing scheduler deletes signals older than 12 months. |
...
| Storage `answerlattice-context/public/{publicBundleId}/v{version}/...` | Public JSON bundle objects and manifest. | Context bundle build. | Public bundle proxy and public/runtime bootstraps. | Serve public-safe compiled context without Firestore reads. | Public read allowed by Storage rules. Scheduler deletes old versions beyond active/last-ready plus previous two. |
