...
The Ticket → Knowledge Loop automatically detects when resolved support tickets reveal knowledge gaps in your help center. When multiple tickets cluster around the same topic, Answerlattice extracts the resolution pattern and proposes a ready-to-approve knowledge article.
...
### 2. Answerlattice detects patterns
...
- **Ticket system active** — You need to be using Answerlattice's ticket system
