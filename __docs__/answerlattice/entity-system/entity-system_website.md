...
## Page: Product Ontology (answerlattice.com/product#ontology)

### Headline

**Your product, structured.**
...
Create your Answerlattice

---

## Page: How It Works (answerlattice.com/how-it-works)

### Section: Entity-First Retrieval

**How Answerlattice answers questions:**

```
User question
    ↓
Detect product concepts (entities)
    ↓
Find documentation covering those concepts
    ↓
