...
If Answerlattice adds **push notifications for emerging friction topics**, a simplified mobile view showing just the health badge + emerging alerts could be valuable. This would pass the Frequency + Value gates.

**Trigger for mobile reassessment:** When `ENABLE_ANSWERLATTICE_FRICTION_NOTIFICATIONS` is implemented.
