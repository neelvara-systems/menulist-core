# Growth Engine - Website Content Decision
...
## 1. Public Website Decision

Growth Engine should not have a public marketing page at first.
...
- separate buyer ICP
- separate public claims
- separate support model
- proof it does not weaken MenuList trust
