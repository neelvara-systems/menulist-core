...
| #   | Edge Case                                                       | ChatGPT Proposal                                                                | Cascade Verdict                                               | Existing Coverage                                                                                             |
| --- | --------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| E24 | Master user switches to outlet context                          | Retain all master permissions, show HQ badge                                    | **AGREE**                                                     | ❌ Not implemented — `session.user.storeId` is single-value; needs `activeStoreContext` + `isMasterUser` flag |
