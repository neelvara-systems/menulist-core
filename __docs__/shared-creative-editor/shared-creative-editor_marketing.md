# Shared Creative Editor - Marketing Notes

## Internal Positioning

Shared Creative Editor is the reusable asset creation layer for products that need static visual outputs. It lets a product offer useful image creation without becoming a generic design suite.
...
- Do not position the editor as a standalone design product.
- Do not claim direct posting or automatic campaign execution.
- Do not claim perfect output for every image source.
- Do not imply CampaignCue owns the editor infrastructure.
