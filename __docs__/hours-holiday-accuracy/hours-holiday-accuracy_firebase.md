...
This repair changed app-side store/project transaction logic, owner recovery surfaces, types, tests, verifiers, and docs. No Firestore rule, index, Storage rule, or Cloud Function source changed, so no Firebase infrastructure deploy was triggered.
