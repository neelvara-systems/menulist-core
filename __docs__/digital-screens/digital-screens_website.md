...
That TV screen in your shop is either blank, showing a year-old slideshow, or running content you forgot to update last month. Meanwhile, customers are standing at the counter wondering what you serve and how much it costs.
...
Use your counter TV for the full menu. Use your waiting area TV for rotating highlights and promotions. Same system, same data, different display.

> **Visual:** Two TVs — one showing menu board, one showing highlights with QR code
...
Your full menu with categories, items, and prices. Designed for the screen above your counter — where customers decide what to order.

> **Visual:** Clean menu board layout with category headers, item names, and prices

### Highlights (Optional)

Rotating promotional slides with featured items and a QR code. Designed for entrance screens, waiting areas, and ambiance.

> **Visual:** Rotating hero images with item name, price, and QR code
