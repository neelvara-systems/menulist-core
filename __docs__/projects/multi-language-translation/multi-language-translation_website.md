...
Translations read naturally in each language. "Butter Chicken" becomes the local equivalent, not a literal translation.
...
- **Meta Description:** Translate your restaurant menu into any language automatically. Customers choose their preferred language when scanning your QR code.
- **Target Keywords:** multilingual menu, menu translation, restaurant menu languages, QR menu translation

## Approved Language
### USE: "Translates automatically", "natural translation", "customers choose their language"
