...
Guest Feedback is a private feedback path. Guests can tell the business about wrong menu details, missing items, outdated information, or service issues without changing the public menu by themselves.

Owners see feedback in the Feedback inbox and decide what to fix in the approved source. Marking feedback as resolved only changes the private inbox status; it does not edit the menu, publish a review, send an automatic reply, or update Google.
...
- Do not describe this as review management or reputation management.
- Do not say MenuList filters reviews before Google.
