...
> Every restaurant, salon, and cafe near you needs a digital menu. Most don't know how to get one. They trust people — not websites. You're the bridge.
...
### Q: Do I need to invest anything?
No. There is no cost to become a partner. You need a MenuList account and a smartphone.

### Q: What does the business owner need to do?
Nothing during setup. You handle everything. They receive login credentials and can manage their menu anytime after.

### Q: Can I collect cash from the business owner?
Yes. The system supports offline payment confirmation. You collect payment and confirm it in the dashboard.

### Q: What happens when a plan expires?
The system handles it automatically. You'll see the expiry date in your dashboard and can renew the plan.

### Q: Is this available everywhere?
Currently available in India only. We'll expand based on demand.
...
**Note:** This page is NOT needed at launch. The reseller program is invitation-only. This content is prepared for when/if a public partner program page is needed.
