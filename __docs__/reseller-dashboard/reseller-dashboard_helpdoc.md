...
### First-Time Setup
1. Log in to MenuList at [menulist.ai](https://menulist.ai)
2. You'll see the **Reseller Dashboard** instead of the regular dashboard
3. Your dashboard shows: total clients, active stores, and an "Onboard New Client" button
...
- Click **"Onboard New Client"** on your dashboard
...
### "Maximum offline activations reached"
You've reached your limit for offline (cash) activations. Contact the MenuList team to increase your limit or use online payment mode for new clients.
...
- [How MenuList Works](/help/how-menulist-works) — What the business owner gets
- [QR Codes & Sharing](/help/qr-codes) — How to share the digital menu

---

## Need More Help?

- **WhatsApp:** Contact the MenuList team directly
