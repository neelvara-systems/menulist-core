...
2. **Customize Your Look** — Pick colors, add your logo, choose a layout that fits your brand.
3. **Share the QR Code** — Print it, stick it on tables. Customers scan and see your live menu.
...
### NEVER USE:
- "AI-powered menu", "Smart recommendations", "Dynamic pricing"
- "Revolutionary", "Game-changing", "Next-gen"
- "You should update your menu" (we don't tell owners what to do)
