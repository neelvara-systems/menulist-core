...
This report preserves May/June validation evidence only. It does not prove the current release, target deployment, provider configuration, browser/device matrix, or production-host behavior.
