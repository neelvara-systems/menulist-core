# Canonica — Market Validation & Strategic Analysis
...
**Yes — significantly.** Before AI: docs drift was annoying. After AI: docs drift becomes **publicly visible failure** (hallucinations, wrong answers). AI adoption is the urgency accelerator. This is Canonica's timing window (2-4 years).
...
### Remove Wrong TAM
Global helpdesk market ($tens of billions) includes call centers, BPO, ITSM — NOT Canonica's market.
...
| Mid-tier ($5M-$50M ARR) — Canonica's target | ~3,000-5,000 |
...
|--------|:----:|-----------|
| LLM providers ship native grounding | Medium | They stay horizontal. Canonica is vertical SaaS-specific. |
...
### Pricing Anchor
Mid-market SaaS support math: 10 agents × $60K salary = $600K/year. If Canonica reduces ticket load 20% → $120K/year value. Charging $12K/year ($1K/month) = 10% of value created. Rational.
