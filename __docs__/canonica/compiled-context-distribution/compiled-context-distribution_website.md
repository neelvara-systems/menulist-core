...
The architecture supports Canonica API/MCP distribution pages only when all of these are true:
...
Current website pages should continue describing Canonica as support knowledge control and runtime reliability, not an agent-write platform.
