...
5. Owner links articles, changelogs, and tickets to the surface from their edit screens.
...
4. If the answer fails, escalation tickets keep the surface context for later knowledge improvement.
