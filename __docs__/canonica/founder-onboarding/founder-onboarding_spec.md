# Canonica — Founder Onboarding (Knowledge Bootstrap Engine) — Spec
...
Canonica's current onboarding flow requires 4 manual steps:
...
- Stores new candidates in `canonica_entityCandidates`
...
- NOT a new set of collections (uses existing Canonica + KB collections)
