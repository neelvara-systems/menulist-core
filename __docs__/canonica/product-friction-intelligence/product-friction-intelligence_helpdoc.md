...
You don't need to set anything up. If you're already using Canonica for support, friction intelligence works automatically.

---

## Where to find it

1. Open your Canonica dashboard
...
1. **Every support interaction creates a signal.** When a user asks a question, gives negative feedback, or escalates to a human agent, Canonica records a friction signal tied to the relevant product entity.

2. **Every night, signals are aggregated.** Canonica calculates friction scores per entity — factoring in query volume, escalation rate, and answer confidence.
...
- Update your Canonica canonical answer for that entity
...
No. Friction intelligence works automatically from your existing support data. Canonica's entity graph handles the mapping.
