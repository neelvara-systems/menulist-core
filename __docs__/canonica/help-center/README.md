...
## Relationship to Canonica

These documents describe the **existing Help Center** — the base support infrastructure built into MenuList. Canonica is the governance layer that sits on top of this infrastructure, adding:
...
For Canonica-specific documentation, see:
