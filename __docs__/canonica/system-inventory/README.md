...
| Support Control | Customer-facing support surfaces and day-to-day support operations. | `/canonica/help`, `/canonica/docs`, `/canonica/release-notes`, `/canonica/support`, `/canonica/knowledge-base`, `/canonica/faqs`, `/canonica/changelog`, `/canonica/support-board`, `/canonica/tickets`, `/canonica/conversations`, `/canonica/weekly-digest` |
...
| Support Board | Implemented | `src/app/(canonica)/canonica/support-board/page.tsx`, `src/components/templates/canonica/supportBoard/CanonicaSupportBoard.tsx`, `src/hooks/canonica/useSupportBoard.ts`, `src/database/canonica/supportBoard.ts` | `canonica_supportBoardCards`, support tickets, `canonica_signalEvents`, mutation proposals | Private owner/staff Kanban for support gaps, internal notes, Needs Answer workflow, and governed answer-proposal creation. |
...
- `/canonica/knowledge-base`, `/canonica/faqs`, `/canonica/changelog`, `/canonica/support-board`, `/canonica/tickets`, `/canonica/conversations`, `/canonica/weekly-digest`.
