# Canonica Pre-Onboarding Input Kit — Test Cases

## Static Website

| ID | Scenario | Expected Result |
| --- | --- | --- |
| POI-WEB-001 | Visit `/pre-onboarding`. | Page loads with Canonica header/footer and explains the pre-onboarding workflow. |
...
| ID | Scenario | Expected Result |
| --- | --- | --- |
| POI-PROMPT-001 | Run prompt in an AI IDE with product name, website URL, source mode, and approval placeholders filled. | Creates `<product-slug>-canonica-pre-onboarding-inputs/`. |
...
| POI-LIVE-003 | Client asks Canonica to answer refund or legal questions. | Keep escalation-gated unless approved source wording exists. |
