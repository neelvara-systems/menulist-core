# Canonica Pre-Onboarding Input Kit — Help Documentation

## Quick Summary

The Pre-Onboarding Kit helps you prepare Canonica inputs before you start setup. You run a master prompt inside your AI coding tool, review the generated folder, and upload selected sources into Canonica Knowledge Intake.
...
Remove them before upload. Canonica does not need private production identifiers to prepare general support knowledge.
...
Keep those review-gated. Canonica should not publish them as official answers until the owner has approved the wording.

## Live Support Gate

Do not use Canonica with live end users until:
