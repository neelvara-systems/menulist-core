# Canonica Pre-Onboarding Input Kit — Owner Guide

## Purpose

This guide explains how a product owner should use the Canonica pre-onboarding prompt before uploading sources into Canonica.
...
| `APPROVAL_STATUS`, `SCREENSHOT_MARKETING_PERMISSION`, `CANONICA_WORKSPACE_STATUS` | Approval and workspace status. |
...
If you want FAQs, website copy, screenshots, or demo walkthroughs, the generated output is still a review brief. Canonica pre-onboarding can prepare source-backed questions, claim candidates, capture steps, and scrub rules, but owner approval is required before anything becomes public.
