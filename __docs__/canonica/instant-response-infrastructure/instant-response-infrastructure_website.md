...
> **Version:** 1.0.0
> **Created:** 2026-03-09
> **Audience:** Public (canonica.app website)
> **Language Governance:** Applied — infrastructure tone, zero jargon

---

## §1 — Feature Section (for canonica.app/features or homepage)
...
### Body
Most support tools recompute every answer from scratch — even when the same question has been asked a thousand times. Canonica remembers. Canonical answers are cached and served instantly, while only genuinely new questions reach the AI pipeline.
...
```html
<title>Instant Answers — Canonica Support Infrastructure</title>
<meta name="description" content="Canonica caches canonical answers for sub-20ms response times. 60-80% of support queries are instant. Zero configuration, automatic invalidation." />
<meta property="og:title" content="Instant Answers — Canonica" />
...
| Feature | Canonica | Typical AI Support |
| ------- | -------- | ------------------ |
