...
5. Confirm `canonica_faqs` docs are created and linked article has `faqIds`.
...
7. Open `/canonica/faqs`, review one generated FAQ, publish it, and confirm it appears in Help Center `Read FAQ`.
