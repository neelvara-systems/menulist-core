# Canonica — Strategic Improvement Report
...
- Store in `platformSummary/canonica_{sId}` (existing summary doc pattern)
...
12. ✅ CF feature flag `ENABLE_CANONICA_NIGHTLY` added
13. ✅ Master Execution Prompt STEP 9B — Canonica completion rules
