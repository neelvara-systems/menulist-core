# Video Reel Studio - Website Content

## Section Goal

Show that CampaignCue can turn a checked campaign into a real, downloadable short video without an external video-generation provider or social account connection.

## Approved Public Copy

> Turn a checked campaign into an editable short video with source-backed scenes, captions, brand styling, and owner approval.
...
- Do not claim a foundational generative-video model.
- Do not promise MP4 on every browser.
