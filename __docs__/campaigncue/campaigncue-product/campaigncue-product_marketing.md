# CampaignCue Product — Marketing And Sales

## Elevator Pitch

CampaignCue turns a local business profile, menu, services, photos, offers, and channel data into ready-to-use campaign packs for WhatsApp, social, Google, video, and ads.
...
| Avoid | Use |
| --- | --- |
| AI Canva | Campaign workspace from business data |
| UGC generator | Recordable owner/staff/creator scripts |
| Social scheduler | Campaign pack with calendar and channel outputs |
| MenuList feature | Separate product with optional MenuList source connector |
| Growth platform | Local campaign execution workspace |

## Pitch Deck Outline

1. Local owners need content but do not know what to promote.
2. CampaignCue starts from business data and shows the next cue.
