...
6. Schedule, export, or publish per location.
7. Compare results by location.

## Important

Check each location before publishing. Hours, services, prices, addresses, and connected channels can differ by branch.
