# Google Local Studio - Marketing Notes

## Positioning

Google Local Studio helps local businesses turn campaign cues into Google Business Profile-ready updates.
...
- Google post formats.
- Manual fallback for unsupported post types.
- Location-aware campaign content.
- Insights capture where authorized.
