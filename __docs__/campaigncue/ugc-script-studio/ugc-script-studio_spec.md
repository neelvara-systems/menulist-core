# UGC Script Studio - Spec

## Summary

UGC Script Studio creates creator-ready scripts, briefs, hooks, shot lists, talking points, and do/don't notes for local-business campaigns.

## Goals

- Make creator briefs clear enough for staff, agencies, or local creators.
- Help owners test local creator/audience fit without paying for follower count alone.
- Keep all claims tied to approved business facts.
- Prevent fake testimonials, fake reviews, misleading before/after claims, and undisclosed sponsorship language.
- Preserve owner approval before the brief is sent or exported.
...
- It does not maintain a creator CRM or marketplace.
