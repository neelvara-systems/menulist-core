...
**Status:** Internal workflow, connector settings, Apify source broker, owned email sequencer queue, and gated provider/source/AI/channel runtime implemented; paid campaigns and Firebase deploy skipped
...
| [Implementation Plan](./menulist-signaldesk_impl.md) | Technical blueprint, architecture, module order, and future file layout. |
...
| [Action Register](./menulist-signaldesk_action-register.md) | Live tracker for documentation and future implementation preparation. |
| [Decision Log](./menulist-signaldesk_decision-log.md) | Durable decisions, assumptions, and boundaries. |
| [_archive/](./_archive/) | Future historical notes, superseded docs, and raw review artifacts. |
...
| Future product code | `SD` proposed for `PRODUCT_IDS.SIGNALDESK` before database-backed implementation |
| Runtime location | Product-isolated module inside this monorepo first; extraction-ready boundaries |
| Future repo/package shorthand | `menulist-signaldesk` |
