...
| `compliance_page_override_save` | "Use this refund policy text" | Compliance override save. Evidence: `src/components/mobile/components/MobileCompliancePagesEditor.tsx`, `src/app/api/compliance/route.ts`, `src/database/compliance/server.ts` | `existing_server_api` | `high_confirm` | Card approve/edit | `C4 guarded server mutation` | `existing_api_only` |
| `compliance_page_override_reset` | "Reset terms to default" | Compliance override reset. Evidence: `src/components/mobile/components/MobileCompliancePagesEditor.tsx`, `src/app/api/compliance/route.ts`, `src/database/compliance/server.ts` | `existing_server_api` | `destructive_confirm` | Card approve/edit | `C4 guarded server mutation` | `existing_api_only` |
