...
**Current tested MenuList product commit:** `afa6ec90608522f5e7653839a490a3cae5d988b2`
...
readback proved exact MenuList product commit `afa6ec90608522f5e7653839a490a3cae5d988b2`
...
| Hosted QA | Exact candidate on QA owner app and tenant subdomain | PASS (deployment identity, fresh entitled owner, Billing, direct-route entitlement bootstrap, menu-link recovery, owner/public status and business-truth propagation, feedback, locations, sharing, assets, staff lifecycle, restricted staff access, and screen recovery) / IN PROGRESS (successful menu upload/item mutation and publish propagation) | `/api/version` returned exact verified MenuList build `afa6ec90608522f5e7653839a490a3cae5d988b2` (`menulist-core-penybcqtd-neelvara-systems.vercel.app`). The isolated 72-hour provider-free fixture passed Firebase Web Auth, exact owner claims, full tenant/store reads, the production active-subscription query, and shared entitlement predicate. Whitespace-tolerant sign-in, truthful QA Billing, first-use project creation, hard-load Dashboard/Projects access, and persistent menu-link failure recovery passed. Publishing and clearing `Closed today` converged on the owner and tenant Official Business Page across warm and cache-busted reads. A reversible short-descriptor edit persisted, appeared on the Official Business Page, rendered `Business settings saved`, then was removed from both owner and public truth. Public feedback required a rating, accepted one private note, appeared in the owner inbox, resolved once, and filtered correctly. The one-location view retained Main Store, blocked an unpaid second outlet, and persisted/reverted its location policy. Business, menu, and screen copy controls produced the correct tenant-scoped URLs; asset previews rendered truthful empty-menu output; Billing and Transactions rendered truthful provider-free/empty states. The active empty screen and invalid-token recovery were truthful. Two isolated no-email staff fixtures proved create/reset one-time credential delivery; all copy controls matched without logging a credential; one staff session signed in, was denied Users, Projects, and Billing owner controls, and the owner force-signed-out then removed both fixture users. Exact `0f9df00…` removed false empty-menu publication status, exact `cde4708…` replaced the false live-sharing claim, exact `370645e…` restored Business Settings completion feedback, and exact `afa6ec9…` restored one-time desktop staff credential delivery. The owner fixture remains in use for upload/item/publish coverage. Live Razorpay checkout was not started. |
...
- Hosted QA exposed and refreshed onto exact verified tested MenuList product
  commit `afa6ec90608522f5e7653839a490a3cae5d988b2`. A fresh provider-free
  ...
  restricted-sign-in/force-sign-out/removal lifecycle. MLRC-052 through
  MLRC-058 are closed. Successful menu-item creation/edit/
