...
**Current tested product commit:** `25d58ae616286ec8d8d0be9f116a4abdda205f24`
...
| Hosted QA | Exact candidate on QA owner app | PASS (deployment identity and bounded recovery interaction) | At `2026-08-25T15:53:08+05:30`, `/api/version` returned exact product commit `25d58ae616286ec8d8d0be9f116a4abdda205f24` with verified provenance. Signed-in pending-owner Billing/history/Help/recovery evidence remains valid through ancestor `801f87f…`; exact-current evidence adds the complete Arabic document-locale route sweep. |
...
| Global signed-out recovery routes | `/403`, `/404`, `/unauthorized`, `/offline`, invalid `/invite`, `/product`, disabled `/creative-editor-smoke`, protected `/test-sentry`, invalid `/msg-preview/[sessionId]` | PASS (behavior) / one copy fix pending hosted retest | Exact hosted Chrome at 320×568 confirmed appropriate recovery, redirect, authentication, or unavailable states. MLRC-034 corrects visibly encoded apostrophes on the shared access-denied screen; no protected content rendered. |
