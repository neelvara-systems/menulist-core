...
- **Evidence:** `verify:auth-security-failure-matrix`, `verify:menulist-api-tenant-safety`, strict TypeScript, focused ESLint, and exact hosted operation-count retest pending the automatic QA deployment.
