...
1. Find a surface showing ⚠ (e.g., "Google Business — Not added")
2. Tap **Copy Link** to copy your menu link
3. Go to that platform (Google, Instagram, WhatsApp) and paste the link
4. Come back to MenuList and tap **I added it**
5. The status changes to ✓

### Remove a Confirmation

If you removed your menu link from a surface:
1. Tap the ✓ row
2. Tap **Remove**
3. Status reverts to ⚠
...
- Start with Google Business — it's the most important surface for customer discovery
- Share the menu link with your staff so everyone sends the same link
- The more surfaces you deploy, the easier it is for customers to find your menu
