...
MenuList records owner actions where the product can observe them and stores owner confirmations for external placements. It does not crawl Google Business, Apple Business Connect, Bing Places, Instagram, WhatsApp, printed tables, or customer devices to prove live placement.
...
- "MenuList records the actions it can observe and lets owners confirm Google, Apple, Bing, Instagram, and WhatsApp placement after they add the link."
