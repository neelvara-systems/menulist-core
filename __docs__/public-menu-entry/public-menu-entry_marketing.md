...
Start with one menu photo or a public menu link you have permission to use. Review the prepared menu, create the owner-controlled public link, and keep updating the same source.
...
- Camera, saved photo, or supported public link input.
