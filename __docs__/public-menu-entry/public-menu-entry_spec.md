...
| Draft | Deterministic, owner-bound, 24-hour, atomic with its extraction job, and addressed through one exact UUID projector across response, route, poll, and claim boundaries. |
