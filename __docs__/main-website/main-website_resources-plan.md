...
| OpenAI crawlers | OpenAI separates `OAI-SearchBot`, `GPTBot`, and `ChatGPT-User`; the first two have independent robots controls. | Current repo already includes all three in policy; keep them and document the distinction. |
