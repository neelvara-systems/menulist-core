# Global Accessibility Test Cases

| Case | Expected result |
| --- | --- |
| Pinch or browser zoom on any maintained app surface | Zoom is not blocked by viewport metadata |
| Tab from the start of an owner or website page | Skip link becomes visible and focuses primary content |
...
| Repeat owner mutations after accessibility changes | Existing mutation, publish, cache, billing, and AI behavior is unchanged |
