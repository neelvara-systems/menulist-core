...
export const CANONICA_FAQS_COLLECTION = DB_COLLECTIONS.CANONICA_FAQS;
export const CANONICA_CACHE_VERSIONS_COLLECTION = DB_COLLECTIONS.CANONICA_CACHE_VERSIONS;
